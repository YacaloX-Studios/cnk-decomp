...
; 120 words
  ...
  00405ea0: daddu $at, $a2, $v0       
  00405ea4: dsubu $t2, $a1, $zero     
  00405ea8: beq    $at, $zero, +44       ; br -> 0x00405ed8
  00405eac: dsubu $t3, $a2, $zero     
