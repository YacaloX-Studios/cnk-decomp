...
; 648 words
  ...
  0042d77c: dsubu $s7, $a3, $zero     
  0042d780: sw     $s2, +112($sp)     
  0042d784: dsubu $s6, $a0, $zero     
  0042d788: sw     $ra, +224($sp)     
  0042d78c: dsubu $s2, $a2, $zero     
  ...
  0042d838: dsubu $a0, $s1, $zero     
  0042d83c: spec3e  $zero,$fp,$a1     
  0042d840: dsubu $a2, $s0, $zero     
  ...
  0042d86c: dsubu $s1, $s0, $zero     
  0042d870: spec3e  $zero,$s4,$a1     
  0042d874: dsubu $a2, $s0, $zero     
  0042d878: lw     $v1, +0($a2)       
  ...
  0042d898: dsubu $s1, $s0, $zero     
  0042d89c: daddu $v0, $s6, $s1       
  0042d8a0: beq    $v0, $zero, +24       ; br -> 0x0042d8bc
  0042d8a4: subu $s0, $s1, $s2        
  0042d8a8: dsubu $a1, $s1, $zero     
  0042d8ac: jalr   $s7, $ra           
  0042d8b0: dsubu $a0, $s0, $zero     
  0042d8b4: bgtzl  $v0, $zero, -160      ; br -> 0x0042d818
  0042d8b8: lw     $a0, +4($sp)       
  0042d8bc: lw     $v1, +12($sp)      
  0042d8c0: dsubu $s0, $s3, $zero     
  0042d8c4: daddu $v0, $s0, $v1       
  0042d8c8: bne    $v0, $zero, -188      ; br -> 0x0042d810
  0042d8cc: dsubu $s1, $s0, $zero     
  ...
  0042d920: dsubu $a0, $s6, $zero     
  0042d924: addu $s1, $s6, $fp        
  0042d928: sll $v0, $fp, 1           
  0042d92c: addu $s3, $v0, $s6        
  0042d930: jalr   $s7, $ra           
  0042d934: dsubu $a1, $s1, $zero     
  0042d938: regimm $v0, $at, +48         ; br -> 0x0042d96c
  0042d93c: dsubu $a0, $s1, $zero     
  0042d940: jalr   $s7, $ra           
  0042d944: dsubu $a1, $s3, $zero     
  0042d948: regimm $v0, $zero, +80       ; br -> 0x0042d99c
  0042d94c: dsubu $a0, $s6, $zero     
  0042d950: jalr   $s7, $ra           
  0042d954: dsubu $a1, $s3, $zero     
  0042d958: addiu  $v1, $zero, -1     
  0042d95c: dsubu $a0, $s3, $zero     
  0042d960: dadd $v1, $v1, $v0        
  0042d964: beq    $zero, $zero, +56     ; br -> 0x0042d9a0
  0042d968: movn   $a0, $s6, $v1      
  0042d96c: jalr   $s7, $ra           
  0042d970: dsubu $a1, $s3, $zero     
  0042d974: bgtzl  $v0, $zero, +40       ; br -> 0x0042d9a0
  0042d978: dsubu $a0, $s1, $zero     
  0042d97c: dsubu $a0, $s6, $zero     
  0042d980: jalr   $s7, $ra           
  0042d984: dsubu $a1, $s3, $zero     
  0042d988: addiu  $v1, $zero, -1     
  0042d98c: dsubu $a0, $s6, $zero     
  0042d990: dadd $v1, $v1, $v0        
  0042d994: beq    $zero, $zero, +8      ; br -> 0x0042d9a0
  0042d998: movn   $a0, $s3, $v1      
  0042d99c: dsubu $a0, $s1, $zero     
  0042d9a0: subu $s4, $s0, $fp        
  0042d9a4: dsubu $s1, $a0, $zero     
  0042d9a8: addu $s3, $s0, $fp        
  0042d9ac: dsubu $a0, $s4, $zero     
  0042d9b0: jalr   $s7, $ra           
  0042d9b4: dsubu $a1, $s0, $zero     
  0042d9b8: regimm $v0, $at, +48         ; br -> 0x0042d9ec
  0042d9bc: dsubu $a0, $s0, $zero     
  0042d9c0: jalr   $s7, $ra           
  0042d9c4: dsubu $a1, $s3, $zero     
  0042d9c8: regimm $v0, $zero, +80       ; br -> 0x0042da1c
  0042d9cc: dsubu $a0, $s4, $zero     
  0042d9d0: jalr   $s7, $ra           
  0042d9d4: dsubu $a1, $s3, $zero     
  0042d9d8: addiu  $v1, $zero, -1     
  0042d9dc: dsubu $a0, $s3, $zero     
  0042d9e0: dadd $v1, $v1, $v0        
  0042d9e4: beq    $zero, $zero, +56     ; br -> 0x0042da20
  0042d9e8: movn   $a0, $s4, $v1      
  0042d9ec: jalr   $s7, $ra           
  0042d9f0: dsubu $a1, $s3, $zero     
  0042d9f4: bgtzl  $v0, $zero, +40       ; br -> 0x0042da20
  0042d9f8: dsubu $a0, $s0, $zero     
  0042d9fc: dsubu $a0, $s4, $zero     
  0042da00: jalr   $s7, $ra           
  0042da04: dsubu $a1, $s3, $zero     
  0042da08: addiu  $v1, $zero, -1     
  0042da0c: dsubu $a0, $s4, $zero     
  0042da10: dadd $v1, $v1, $v0        
  0042da14: beq    $zero, $zero, +8      ; br -> 0x0042da20
  0042da18: movn   $a0, $s3, $v1      
  0042da1c: dsubu $a0, $s0, $zero     
  0042da20: sll $v0, $fp, 1           
  0042da24: subu $s3, $s5, $fp        
  0042da28: subu $s4, $s5, $v0        
  0042da2c: dsubu $s0, $a0, $zero     
  0042da30: dsubu $a0, $s4, $zero     
  0042da34: jalr   $s7, $ra           
  0042da38: dsubu $a1, $s3, $zero     
  0042da3c: regimm $v0, $at, +48         ; br -> 0x0042da70
  0042da40: dsubu $a0, $s3, $zero     
  0042da44: jalr   $s7, $ra           
  0042da48: dsubu $a1, $s5, $zero     
  0042da4c: regimm $v0, $zero, +80       ; br -> 0x0042daa0
  0042da50: dsubu $a0, $s4, $zero     
  0042da54: jalr   $s7, $ra           
  0042da58: dsubu $a1, $s5, $zero     
  0042da5c: addiu  $v1, $zero, -1     
  0042da60: dsubu $a0, $s5, $zero     
  0042da64: dadd $v1, $v1, $v0        
  0042da68: beq    $zero, $zero, +56     ; br -> 0x0042daa4
  0042da6c: movn   $a0, $s4, $v1      
  0042da70: jalr   $s7, $ra           
  0042da74: dsubu $a1, $s5, $zero     
  0042da78: bgtzl  $v0, $zero, +40       ; br -> 0x0042daa4
  0042da7c: dsubu $a0, $s3, $zero     
  0042da80: dsubu $a0, $s4, $zero     
  0042da84: jalr   $s7, $ra           
  0042da88: dsubu $a1, $s5, $zero     
  0042da8c: addiu  $v1, $zero, -1     
  0042da90: dsubu $a0, $s4, $zero     
  0042da94: dadd $v1, $v1, $v0        
  0042da98: beq    $zero, $zero, +8      ; br -> 0x0042daa4
  0042da9c: movn   $a0, $s5, $v1      
  0042daa0: dsubu $a0, $s3, $zero     
  0042daa4: dsubu $s5, $a0, $zero     
  0042daa8: dsubu $a0, $s1, $zero     
  0042daac: jalr   $s7, $ra           
  0042dab0: dsubu $a1, $s0, $zero     
  0042dab4: regimm $v0, $at, +48         ; br -> 0x0042dae8
  0042dab8: dsubu $a0, $s0, $zero     
  0042dabc: jalr   $s7, $ra           
  0042dac0: dsubu $a1, $s5, $zero     
  0042dac4: regimm $v0, $zero, +80       ; br -> 0x0042db18
  0042dac8: dsubu $a0, $s1, $zero     
  0042dacc: jalr   $s7, $ra           
  0042dad0: dsubu $a1, $s5, $zero     
  0042dad4: addiu  $v1, $zero, -1     
  0042dad8: dsubu $a0, $s5, $zero     
  0042dadc: dadd $v1, $v1, $v0        
  0042dae0: beq    $zero, $zero, +56     ; br -> 0x0042db1c
  0042dae4: movn   $a0, $s1, $v1      
  0042dae8: jalr   $s7, $ra           
  0042daec: dsubu $a1, $s5, $zero     
  0042daf0: bgtzl  $v0, $zero, +40       ; br -> 0x0042db1c
  0042daf4: dsubu $a0, $s0, $zero     
  0042daf8: dsubu $a0, $s1, $zero     
  0042dafc: jalr   $s7, $ra           
  0042db00: dsubu $a1, $s5, $zero     
  0042db04: addiu  $v1, $zero, -1     
  0042db08: dsubu $a0, $s1, $zero     
  0042db0c: dadd $v1, $v1, $v0        
  0042db10: beq    $zero, $zero, +8      ; br -> 0x0042db1c
  0042db14: movn   $a0, $s5, $v1      
  0042db18: dsubu $a0, $s0, $zero     
  0042db1c: dsubu $s0, $a0, $zero     
  0042db20: lw     $v0, +4($sp)       
  ...
  0042db54: dsubu $a0, $s0, $zero     
  0042db58: spec3c  $zero,$v0,$v0     
  0042db5c: dsubu $a2, $s6, $zero     
  ...
  0042dba4: dsubu $a0, $s0, $zero     
  0042dba8: spec3e  $zero,$v0,$a1     
  0042dbac: dsubu $a2, $s6, $zero     
  0042dbb0: lw     $v1, +0($a0)       
  ...
  0042dbf0: dsubu $s3, $s1, $zero     
  0042dbf4: addu $s4, $v0, $s6        
  0042dbf8: srl $v0, $s2, 3           
  0042dbfc: dsubu $s0, $s4, $zero     
  ...
  0042dc4c: dsubu $a1, $s3, $zero     
  0042dc50: dsubu $a0, $s1, $zero     
  ...
  0042dc84: dsubu $s3, $a3, $zero     
  0042dc88: lw     $v1, +32($sp)      
  0042dc8c: dsubu $a1, $s3, $zero     
  0042dc90: dsubu $a0, $s1, $zero     
  ...
  0042dcc0: dsubu $s3, $a3, $zero     
  0042dcc4: dsubu $s1, $t1, $zero     
  0042dcc8: daddu $v0, $s0, $s1       
  0042dccc: bne    $v0, $zero, +28       ; br -> 0x0042dcec
  0042dcd0: lw     $a0, +4($sp)       
  0042dcd4: dsubu $a1, $s6, $zero     
  0042dcd8: jalr   $s7, $ra           
  0042dcdc: dsubu $a0, $s1, $zero     
  0042dce0: dsubu $a1, $v0, $zero     
  ...
  0042dd34: dsubu $a0, $s0, $zero     
  0042dd38: dsubu $a1, $s4, $zero     
  ...
  0042dd6c: dsubu $s4, $a3, $zero     
  0042dd70: dsubu $a1, $s4, $zero     
  ...
  0042dda0: dsubu $s4, $a3, $zero     
  0042dda4: dsubu $s0, $t0, $zero     
  0042dda8: daddu $v0, $s0, $s1       
  0042ddac: bne    $v0, $zero, +212      ; br -> 0x0042de84
  0042ddb0: dsubu $a1, $s6, $zero     
  0042ddb4: sw     $t1, +64($sp)      
  0042ddb8: jalr   $s7, $ra           
  0042ddbc: dsubu $a0, $s0, $zero     
  0042ddc0: dsubu $a1, $v0, $zero     
  ...
  0042ddfc: dsubu $a1, $s1, $zero     
  0042de00: dsubu $a0, $s0, $zero     
  ...
  0042de3c: dsubu $a1, $s1, $zero     
  0042de40: dsubu $a0, $s0, $zero     
  ...
  0042de74: dsubu $s1, $t1, $zero     
  0042de78: dsubu $s0, $t0, $zero     
  ...
  0042def0: dsubu $a0, $s1, $zero     
  0042def4: spec3e  $zero,$fp,$a1     
  0042def8: dsubu $a2, $s0, $zero     
  ...
  0042df24: dsubu $s1, $s0, $zero     
  0042df28: spec3e  $zero,$s4,$a1     
  0042df2c: dsubu $a2, $s0, $zero     
  0042df30: lw     $v1, +0($a2)       
  ...
  0042dfc8: dsubu $a2, $v1, $zero     
  0042dfcc: spec3c  $zero,$v0,$v0     
  0042dfd0: dsubu $a0, $s6, $zero     
  ...
  0042e004: dsubu $a2, $v1, $zero     
  0042e008: spec3e  $zero,$v0,$a1     
  0042e00c: dsubu $a0, $s6, $zero     
  0042e010: lw     $v1, +0($a2)       
  ...
  0042e058: dsubu $a0, $s1, $zero     
  0042e05c: spec3c  $zero,$v0,$v0     
  0042e060: dsubu $a2, $v1, $zero     
  ...
  0042e08c: dsubu $a1, $a3, $zero     
  0042e090: spec3c  $zero,$a1,$v0     
  0042e094: dsubu $a0, $s1, $zero     
  0042e098: spec3e  $zero,$v0,$a1     
  0042e09c: dsubu $a2, $v1, $zero     
  0042e0a0: lw     $v1, +0($a2)       
  ...
  0042e0c0: dsubu $a1, $a3, $zero     
  0042e0c4: daddu $v0, $s2, $a1       
  0042e0c8: beql   $v0, $zero, +40       ; br -> 0x0042e0f4
  0042e0cc: dsubu $a1, $s0, $zero     
  0042e0d0: divu   $s2, $a1, +0       
  0042e0d4: beql   $s2, $zero, +4        ; br -> 0x0042e0dc
  0042e0d8: break                     
  0042e0dc: dsubu $a0, $s6, $zero     
  0042e0e0: dsubu $a2, $s2, $zero     
  0042e0e4: mflo   $zero, $zero, +0   
  0042e0e8: jal   0xf042d770             ; -> FUN_0042d770
  0042e0ec: dsubu $a3, $s7, $zero     
  0042e0f0: dsubu $a1, $s0, $zero     
  0042e0f4: daddu $v0, $s2, $a1       
