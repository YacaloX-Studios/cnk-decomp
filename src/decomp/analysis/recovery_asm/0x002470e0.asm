...
; 364 words
  ...
  00247164: sll    $v0, $zero, +2     
  00247168: addiu  $t4, $t4, +4       
  0024716c: addu   $sp, $v0, +0       
  00247170: lw     $v0, +304($v1)     
  00247174: addiu  $v0, $v0, +1       
  00247178: bne    $t6, $zero, -32       ; br -> 0x0028715c
  ...
  0024719c: daddu  $t6, $v0, +0       
  002471a0: addiu  $t6, $t6, +1       
  002471a4: sltiu  $at, $t6, +16      
  002471a8: bne    $at, $zero, -24       ; br -> 0x00287194
  ...
  00247218: sll    $t2, $zero, +1     
  0024721c: addiu  $t6, $t6, +1       
  00247220: daddu  $t4, $t6, +0       
  00247224: bne    $t2, $zero, -40       ; br -> 0x00287200
  00247228: addiu  $t7, $t7, +4       
  0024722c: sll    $zero, $zero, +0   
  00247230: sll    $t4, $zero, +2     
  00247234: addu   $sp, $t2, +0       
  00247238: addiu  $t7, $t2, +304     
  0024723c: lw     $t2, +0($t7)       
  00247240: subu   $t2, $s0, +0       
  00247244: regimm $t6, $zero, +132      ; br -> 0x002472cc
  00247248: sll    $zero, $zero, +0   
  0024724c: addu   $t6, $t2, +0       
  00247250: addiu  $t4, $t4, -1       
  00247254: sw     $t2, +0($t7)       
  00247258: addiu  $s0, $sp, +308     
  0024725c: sw     $zero, +180($sp)   
  00247260: dsubu  $zero, $zero, +0   
  00247264: beq    $t4, $zero, +108      ; br -> 0x002472d4
  00247268: addiu  $s2, $sp, +184     
  0024726c: lw     $t2, +0($s0)       
  00247270: addiu  $t4, $t4, -1       
  00247274: addu   $t2, $t7, +0       
  00247278: addiu  $s0, $s0, +4       
  0024727c: sw     $t7, +0($s2)       
  00247280: bne    $t4, $zero, -24       ; br -> 0x0028726c
  00247284: addiu  $s2, $s2, +4       
  00247288: beq    $zero, $zero, +76     ; br -> 0x002472d8
  0024728c: dsubu  $zero, $zero, +0   
  00247290: sw     $zero, +0($t1)     
  00247294: dsubu  $zero, $zero, +0   
  00247298: beq    $zero, $zero, +956    ; br -> 0x00247658
  0024729c: sw     $zero, +0($t2)     
  002472a0: daddu  $t6, $v0, +0       
  002472a4: dsubu  $zero, $t6, +0     
  002472a8: beq    $at, $zero, -244      ; br -> 0x002871b8
  002472ac: dsubu  $zero, $t6, +0     
  002472b0: beq    $zero, $zero, -252    ; br -> 0x002871b8
  002472b4: dsubu  $zero, $t6, +0     
  002472b8: daddu  $v0, $t4, +0       
  002472bc: beq    $at, $zero, -224      ; br -> 0x002871e0
  002472c0: dsubu  $zero, $t4, +0     
  002472c4: beq    $zero, $zero, -232    ; br -> 0x002871e0
  002472c8: dsubu  $zero, $t4, +0     
  002472cc: beq    $zero, $zero, +904    ; br -> 0x00247658
  002472d0: addiu  $v0, $zero, -3     
  002472d4: dsubu  $zero, $zero, +0   
  002472d8: lw     $t4, +392($sp)     
  002472dc: lw     $t2, +0($a0)       
  002472e0: bne    $t2, $zero, +500      ; br -> 0x002474d8
  002472e4: addiu  $a0, $a0, +4       
  002472e8: addiu  $s2, $s2, +1       
  002472ec: daddu  $a1, $s2, +0       
  002472f0: bne    $t2, $zero, -24       ; br -> 0x002872dc
  002472f4: sll    $zero, $zero, +0   
  002472f8: sll    $s1, $zero, +2     
  002472fc: lw     $s0, +392($sp)     
  00247300: addu   $sp, $a0, +0       
  00247304: dadd   $t5, $s1, +0       
  00247308: lw     $a0, +176($a0)     
  0024730c: dsubu  $zero, $zero, +0   
  00247310: sw     $zero, +240($sp)   
  00247314: addiu  $s5, $zero, -1     
  00247318: subu   $v0, $zero, +0     
  0024731c: dsubu  $zero, $zero, +0   
  00247320: dsubu  $zero, $zero, +0   
  00247324: bne    $at, $zero, +80       ; br -> 0x00247378
  00247328: sw     $zero, +176($sp)   
  0024732c: sll    $t5, $zero, +2     
  00247330: sll    $a0, $zero, +2     
  00247334: addu   $sp, $a1, +0       
  00247338: addu   $a0, $s0, +0       
  ...
  0024753c: dsubu  $zero, $zero, +0   
  00247540: lw     $t2, +0($s0)       
  00247544: sw     $a1, +376($sp)     
  00247548: addiu  $a1, $sp, +380     
  0024754c: sw     $t2, +0($a1)       
  00247550: addiu  $s0, $s0, +4       
  00247554: srlv   $t9, $s3, +0       
  00247558: daddu  $t7, $t8, +0       
  0024755c: beq    $at, $zero, +116      ; br -> 0x002475d4
  00247560: sllv   $t5, $a0, +0       
  00247564: sll    $t8, $zero, +3     
  00247568: sll    $t2, $zero, +3     
  0024756c: addu   $a0, $s4, +0       
  00247570: lwc1   $at, +376($sp)     
  00247574: lwc1   $zero, +380($sp)   
  00247578: swc1   $at, +0($s2)       
  0024757c: addu   $t2, $t8, +0       
  00247580: swc1   $zero, +4($s2)     
  00247584: daddu  $t7, $t8, +0       
  00247588: addu   $a1, $s2, +0       
  0024758c: bne    $a0, $zero, -24       ; br -> 0x00287578
  00247590: sll    $zero, $zero, +0   
  00247594: beq    $zero, $zero, +64     ; br -> 0x002475d8
  00247598: lw     $a1, +160($sp)     
  0024759c: beq    $zero, $zero, -76     ; br -> 0x00287554
  002475a0: sw     $a1, +376($sp)     
  002475a4: subu   $a2, $a1, +0       
  002475a8: addiu  $s0, $s0, +4       
  002475ac: sll    $a1, $zero, +2     
  002475b0: addu   $a1, $t0, +0       
  002475b4: lw     $s2, +0($t2)       
  002475b8: addu   $a1, $a3, +0       
  002475bc: lw     $t2, +0($a1)       
  002475c0: addiu  $a1, $s2, +80      
  002475c4: sw     $a1, +376($sp)     
  002475c8: addiu  $a1, $sp, +380     
  002475cc: beq    $zero, $zero, -124    ; br -> 0x00287554
  002475d0: sw     $t2, +0($a1)       
  002475d4: lw     $a1, +160($sp)     
  002475d8: dsubu  $zero, $a1, +0     
  002475dc: and    $a0, $t9, +0       
  002475e0: beq    $a0, $zero, +36       ; br -> 0x00247608
  002475e4: sll    $zero, $zero, +0   
  002475e8: xor    $a1, $t9, +0       
  002475ec: srl    $a1, $zero, +1     
  002475f0: and    $a1, $t9, +0       
  002475f4: sll    $zero, $zero, +0   
  002475f8: sll    $zero, $zero, +0   
  002475fc: bne    $a0, $zero, -24       ; br -> 0x002875e8
  00247600: sll    $zero, $zero, +0   
  00247604: sll    $zero, $zero, +0   
  00247608: xor    $a1, $t9, +0       
  0024760c: sllv   $t5, $s3, +0       
  00247610: sll    $s5, $zero, +2     
  00247614: addiu  $a1, $a1, -1       
  00247618: addu   $sp, $a0, +0       
  0024761c: addiu  $a0, $a0, +176     
  00247620: and    $a1, $t9, +0       
  00247624: lw     $a1, +0($a0)       
  00247628: beq    $t2, $a1, -720        ; br -> 0x0028735c
  0024762c: sll    $zero, $zero, +0   
  00247630: addiu  $a0, $a0, -4       
  00247634: subu   $v0, $s3, +0       
  00247638: lw     $a1, +0($a0)       
  0024763c: sllv   $t5, $s3, +0       
  00247640: addiu  $t2, $t2, -1       
  00247644: and    $t2, $t9, +0       
  00247648: bne    $t2, $a1, -28         ; br -> 0x00287630
  0024764c: addiu  $s5, $s5, -1       
  00247650: beq    $zero, $zero, -756    ; br -> 0x00287360
  00247654: dsubu  $zero, $s6, +0     
