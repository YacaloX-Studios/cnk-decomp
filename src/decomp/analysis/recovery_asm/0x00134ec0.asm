...
; 28 words
  ...
  00134ec0: sll    $a1, $zero, +5     
  00134ec4: addu   $a0, $v0, +0       
  00134ec8: lw     $v0, +28($v1)      
  00134ecc: beq    $v0, $zero, +44       ; br -> 0x00134efc
  00134ed0: dsubu  $zero, $zero, +0   
