...
; 66 words
  ...
  0042a4e4: sw     $s0, +0($sp)       
  0042a4e8: sw     $ra, +16($sp)      
  0042a4ec: dsubu  $zero, $a0, +0     
  ...
  0042a5a0: spec2f  $a1,$v0,$a1       
  0042a5a4: lw     $v0, +60($s0)      
  0042a5a8: beq    $zero, $zero, +36     ; br -> 0x0042a5d0
  0042a5ac: spec2f  $a1,$v0,$a1       
  0042a5b0: beq    $v0, $zero, +32       ; br -> 0x0042a5d4
  0042a5b4: dsubu  $zero, $a1, +0     
  0042a5b8: lw     $v1, +0($s0)       
  0042a5bc: beq    $v1, $zero, +24       ; br -> 0x0042a5d8
  0042a5c0: lw     $ra, +16($sp)      
  0042a5c4: lw     $v0, +16($s0)      
  0042a5c8: subu   $v0, $v1, +0       
  0042a5cc: dsubu  $v0, $a1, +0       
  0042a5d0: dsubu  $zero, $a1, +0     
  0042a5d4: lw     $ra, +16($sp)      
  0042a5d8: lw     $s0, +0($sp)       
  0042a5dc: jr     $ra                
