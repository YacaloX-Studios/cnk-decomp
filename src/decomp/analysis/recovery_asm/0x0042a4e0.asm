...
; 66 words
  ...
  0042a55c: dsubu $a1, $zero, $zero   
  0042a560: lw     $a0, +28($s0)      
  0042a564: jalr   $v0, $ra           
  0042a568: addiu  $a2, $zero, +1     
  0042a56c: dsubu $a1, $v0, $zero     
