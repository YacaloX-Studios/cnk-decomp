...
; 70 words
  ...
  0042bc54: dsubu $v0, $s1, $zero     
  0042bc58: jal   0xf04299a0             ; -> FUN_004299a0
  0042bc5c: dsubu $a0, $s0, $zero     
  0042bc60: dsubu $v1, $v0, $zero     
  0042bc64: bne    $v1, $zero, +8        ; br -> 0x0042bc70
  0042bc68: addiu  $v0, $zero, -1     
  0042bc6c: dsubu $v0, $s1, $zero     
