...
; 70 words
  ...
  0042bb74: sw     $s1, +16($sp)      
  0042bb78: sw     $s0, +0($sp)       
  0042bb7c: sw     $ra, +32($sp)      
  0042bb80: dsubu  $zero, $a1, +0     
  0042bb84: lw     $v0, +84($s0)      
  0042bb88: bne    $v0, $zero, +20       ; br -> 0x0042bba0
  0042bb8c: dsubu  $zero, $a0, +0     
