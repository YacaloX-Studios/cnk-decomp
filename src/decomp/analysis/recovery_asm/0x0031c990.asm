...
; 208 words
  ...
  0031cb20: slt $v1, $t9, $a1         
  0031cb24: bne    $v1, $zero, -44       ; br -> 0x0031cafc
  0031cb28: sll $zero, $zero, 0       
  0031cb2c: sll $zero, $zero, 0       
  0031cb30: sw     $zero, +20($a0)    
  0031cb34: lq     $s5, +80($sp)      
  0031cb38: lq     $s4, +64($sp)      
  0031cb3c: lq     $s3, +48($sp)      
  0031cb40: lq     $s2, +32($sp)      
  0031cb44: lq     $s1, +16($sp)      
  0031cb48: lq     $s0, +0($sp)       
  0031cb4c: jr     $ra                
