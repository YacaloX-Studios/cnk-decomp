...
; 68 words
  ...
  00429e90: dsubu  $zero, $s0, +0     
  00429e94: dsubu  $zero, $zero, +0   
  00429e98: jal   0xf042a0d0             ; -> 0x0042a0d0
  00429e9c: addiu  $a2, $zero, +2     
  00429ea0: dsubu  $zero, $s0, +0     
