...
; 102 words
  ...
  0042acd8: sq     $s1, +16($sp)      
  0042acdc: sq     $s0, +0($sp)       
  0042ace0: daddu $s1, $a0, $zero     
  0042ace4: sq     $ra, +32($sp)      
  0042ace8: beq    $s1, $v0, +356        ; br -> 0x0042ae50
  0042acec: daddu $s0, $a1, $zero     
  ...
  0042ade0: lw     $a0, +4($s0)       
  0042ade4: lw     $a0, +0($s0)       
  0042ade8: sltu $v0, $v0, $a0        
  0042adec: beql   $v0, $zero, +44       ; br -> 0x0042ae1c
  0042adf0: lw     $a0, +4($s0)       
  0042adf4: lbu    $v0, -1($a0)       
  ...
  0042ae38: daddu $v0, $s1, $zero     
  0042ae3c: sw     $v1, +56($s0)      
  0042ae40: sw     $a3, +48($s0)      
  0042ae44: sw     $a1, +52($s0)      
  0042ae48: sw     $a2, +0($s0)       
  0042ae4c: sb     $s1, +66($s0)      
  0042ae50: lq     $ra, +32($sp)      
  0042ae54: lq     $s1, +16($sp)      
  0042ae58: lq     $s0, +0($sp)       
  0042ae5c: jr     $ra                
