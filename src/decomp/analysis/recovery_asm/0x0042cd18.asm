...
; 64 words
  ...
  0042cd1c: sq     $s1, +16($sp)      
  0042cd20: sq     $s3, +48($sp)      
  0042cd24: daddu $s1, $a2, $zero     
  0042cd28: sq     $s2, +32($sp)      
  0042cd2c: daddu $s3, $a0, $zero     
  0042cd30: sq     $ra, +64($sp)      
  0042cd34: andi   $v1, $s1, +3       
  0042cd38: sq     $s0, +0($sp)       
  0042cd3c: beq    $v1, $zero, +40       ; br -> 0x0042cd68
  0042cd40: daddu $s2, $a1, $zero     
  ...
  0042cda4: daddu $s0, $v0, $zero     
  0042cda8: daddu $a0, $s3, $zero     
  0042cdac: daddu $a1, $s0, $zero     
  0042cdb0: jal   0xf042cb00             ; -> FUN_0042cb00
  0042cdb4: daddu $a2, $s0, $zero     
  0042cdb8: sw     $v0, +0($s0)       
  0042cdbc: sw     $zero, +0($v0)        ; GLOBAL 0x006a0000
  0042cdc0: daddu $s0, $v0, $zero     
  0042cdc4: andi   $v0, $s1, +1       
  0042cdc8: beq    $v0, $zero, +32       ; br -> 0x0042cdec
  0042cdcc: daddu $a1, $s2, $zero     
  0042cdd0: daddu $a0, $s3, $zero     
  0042cdd4: jal   0xf042cb00             ; -> FUN_0042cb00
  0042cdd8: daddu $a2, $s0, $zero     
  0042cddc: daddu $a1, $s2, $zero     
  0042cde0: daddu $a0, $s3, $zero     
  0042cde4: jal   0xf042c708             ; -> 0x0042c708
  0042cde8: daddu $s2, $v0, $zero     
  0042cdec: sra $s1, $s1, 1           
  0042cdf0: bnel   $s1, $zero, -84       ; br -> 0x0042cda0
  0042cdf4: lw     $v0, +0($s0)       
  0042cdf8: daddu $v0, $s2, $zero     
  0042cdfc: lq     $ra, +64($sp)      
  0042ce00: lq     $s3, +48($sp)      
  0042ce04: lq     $s2, +32($sp)      
  0042ce08: lq     $s1, +16($sp)      
  0042ce0c: lq     $s0, +0($sp)       
  0042ce10: jr     $ra                
