...
; 60 words
  ...
  0042f6e4: sb     $zero, -1($a0)     
  0042f6e8: daddu $a0, $zero, $zero   
  0042f6ec: jr     $ra                
  0042f6f0: sw     $a0, +0($a2)       
  0042f6f4: bnel   $v1, $zero, -32       ; br -> 0x0042f6d8
  0042f6f8: lb     $v1, +0($a3)       
  0042f6fc: beq    $zero, $zero, -56     ; br -> 0x0042f6c8
  0042f700: lb     $t0, +0($a0)       
  0042f704: sll $zero, $zero, 0       
  0042f708: lb     $v0, +0($a0)       
  0042f70c: beq    $v0, $zero, +56       ; br -> 0x0042f748
  0042f710: daddu $a1, $a0, $zero     
  0042f714: lui   $v0, 0x006a0000     
  0042f718: addiu  $a3, $v0, +17361   
  0042f71c: lb     $a2, +0($a1)       
  0042f720: addu $v1, $a2, $a3        
  0042f724: lbu    $v0, +0($v1)       
  ...
  0042f73c: lb     $v0, +0($a1)       
  0042f740: bnel   $v0, $zero, -36       ; br -> 0x0042f720
  0042f744: lb     $a2, +0($a1)       
  0042f748: jr     $ra                
  0042f74c: daddu $v0, $a0, $zero     
