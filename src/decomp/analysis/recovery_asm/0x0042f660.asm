...
; 60 words
  ...
  0042f664: dsubu $a3, $a1, $zero     
  0042f668: lw     $a0, +0($a2)       
  0042f66c: bnel   $a0, $zero, +16       ; br -> 0x0042f680
  0042f670: lw     $t0, +0($a0)       
  0042f674: jr     $ra                
  0042f678: dsubu $v0, $zero, $zero   
  0042f67c: lw     $t0, +0($a0)       
  0042f680: lw     $v1, +0($a3)       
  ...
  0042f6b8: jr     $ra                
  0042f6bc: dsubu $v0, $zero, $zero   
  0042f6c0: lw     $t0, +0($a0)       
  0042f6c4: sll $zero, $zero, 0       
  0042f6c8: dsubu $a3, $a1, $zero     
