...
; 90 words
  ...
  0042a81c: sq     $s0, +0($sp)       
  0042a820: sq     $ra, +16($sp)      
  0042a824: daddu $s0, $a0, $zero     
  ...
  0042a928: daddu $a1, $v1, $zero     
  0042a92c: lw     $a2, +20($s0)      
  0042a930: jalr   $v0, $ra           
  0042a934: sw     $v1, +0($s0)       
  0042a938: daddu $v1, $v0, $zero     
  0042a93c: lhu    $v0, +12($s0)      
  0042a940: sw     $v1, +4($s0)       
  0042a944: andi   $v0, $v0, -8193    
  0042a948: bgtz   $v1, $zero, +32       ; br -> 0x0042a96c
  0042a94c: sh     $v0, +12($s0)      
  ...
  0042a964: beq    $zero, $zero, -228    ; br -> 0x0042a884
  0042a968: sh     $v0, +12($s0)      
  0042a96c: daddu $v0, $zero, $zero   
  0042a970: lq     $ra, +16($sp)      
  0042a974: lq     $s0, +0($sp)       
  0042a978: jr     $ra                
