...
; 90 words
  ...
  0042a928: dsubu $a1, $v1, $zero     
  0042a92c: lw     $a2, +20($s0)      
  0042a930: jalr   $v0, $ra           
  0042a934: sw     $v1, +0($s0)       
  0042a938: dsubu $v1, $v0, $zero     
