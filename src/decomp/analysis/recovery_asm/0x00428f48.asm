...
; 496 words
  ...
  004294e0: dsubu $a0, $a3, $zero     
  004294e4: dsubu $a1, $t0, $zero     
  004294e8: dsubu $v0, $a2, $zero     
  ...
  004296a8: lw     $v1, +0($a1)       
  004296ac: dsubu $a0, $a3, $zero     
  004296b0: beq    $a2, $zero, +72       ; br -> 0x004296fc
  004296b4: dsubu $v0, $a2, $zero     
  004296b8: lw     $v0, +0($a1)       
