...
; 154 words
  ...
  0042ff60: and    $v0, $a0, +0       
  0042ff64: andi   $v1, $v1, +1       
  0042ff68: or     $s3, $v1, +0       
  0042ff6c: addu   $s3, $s4, +0       
  0042ff70: sw     $v1, +4($s4)       
