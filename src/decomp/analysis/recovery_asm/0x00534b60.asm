...
; 132 words
  ...
  00534b64: dsubu $t4, $zero, $zero   
  00534b68: sw     $s0, +0($sp)       
  00534b6c: dsubu $t3, $zero, $zero   
  00534b70: dsubu $t7, $zero, $zero   
