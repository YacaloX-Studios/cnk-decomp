...
; 304 words
  ...
  0036d698: sd     $ra, +144($sp)     
  0036d69c: sq     $s7, +128($sp)     
  0036d6a0: sq     $s6, +112($sp)     
  0036d6a4: daddu $s7, $a0, $zero     
  0036d6a8: sq     $s5, +96($sp)      
  0036d6ac: daddu $s6, $t2, $zero     
  0036d6b0: sq     $s4, +80($sp)      
  0036d6b4: daddu $s5, $a1, $zero     
  0036d6b8: sq     $s3, +64($sp)      
  0036d6bc: daddu $s4, $a2, $zero     
  0036d6c0: sq     $s2, +48($sp)      
  0036d6c4: daddu $s3, $a3, $zero     
  0036d6c8: sq     $s1, +32($sp)      
  0036d6cc: daddu $s2, $t0, $zero     
  0036d6d0: sq     $s0, +16($sp)      
  0036d6d4: daddu $s1, $t1, $zero     
  0036d6d8: swc1   $s4, +0($sp)       
  0036d6dc: daddu $s0, $zero, $zero   
  ...
  0036d77c: daddu $a1, $s1, $zero     
  0036d780: addu $v0, $s4, $v0        
  0036d784: lhu    $v0, +0($v0)          ; GLOBAL 0x3f800000
  ...
  0036d7a4: lq     $v1, +0($v1)       
  0036d7a8: sq     $v1, +0($v0)          ; GLOBAL 0x3f800000
  0036d7ac: andi   $v0, $s0, +255     
  0036d7b0: addiu  $a0, $sp, +320     
  0036d7b4: sll $v0, $v0, 1           
  0036d7b8: daddu $a1, $s6, $zero     
  0036d7bc: addu $v0, $s2, $v0        
  0036d7c0: lhu    $v0, +0($v0)          ; GLOBAL 0x3f800000
  ...
  0036d7e0: lq     $v1, +0($v1)       
  0036d7e4: sq     $v1, +0($v0)          ; GLOBAL 0x3f800000
  ...
  0036d838: lq     $v0, +0($v0)          ; GLOBAL 0x3f800000
  0036d83c: sq     $v0, +0($v1)       
  0036d840: addiu  $v0, $s7, +16      
  0036d844: lq     $v1, +0($v1)       
  0036d848: sq     $v1, +0($v0)          ; GLOBAL 0x3f800000
  ...
  0036d8b0: lq     $v0, +0($v0)          ; GLOBAL 0x3f800000
  0036d8b4: sq     $v0, +0($a1)       
  ...
  0036d8d0: lq     $v1, +0($v1)       
  0036d8d4: sq     $v1, +0($v0)          ; GLOBAL 0x3f000000
  ...
  0036d904: ld     $ra, +144($sp)     
  0036d908: lq     $s7, +128($sp)     
  0036d90c: lwc1   $s4, +0($sp)       
  0036d910: lq     $s6, +112($sp)     
  0036d914: lq     $s5, +96($sp)      
  0036d918: lq     $s4, +80($sp)      
  0036d91c: lq     $s3, +64($sp)      
  0036d920: lq     $s2, +48($sp)      
  0036d924: lq     $s1, +32($sp)      
  0036d928: lq     $s0, +16($sp)      
  0036d92c: jr     $ra                
