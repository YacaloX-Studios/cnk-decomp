...
; 304 words
  ...
  0036d6a4: dsubu  $zero, $a0, +0     
  0036d6a8: sw     $s5, +96($sp)      
  0036d6ac: dsubu  $zero, $t2, +0     
  0036d6b0: sw     $s4, +80($sp)      
  0036d6b4: dsubu  $zero, $a1, +0     
  0036d6b8: sw     $s3, +64($sp)      
  0036d6bc: dsubu  $zero, $a2, +0     
  0036d6c0: sw     $s2, +48($sp)      
  0036d6c4: dsubu  $zero, $a3, +0     
  0036d6c8: sw     $s1, +32($sp)      
  0036d6cc: dsubu  $zero, $t0, +0     
  0036d6d0: sw     $s0, +16($sp)      
  0036d6d4: dsubu  $zero, $t1, +0     
  0036d6d8: swc1   $s4, +0($sp)       
  0036d6dc: dsubu  $zero, $zero, +0   
  ...
  0036d778: sll    $v0, $zero, +1     
  0036d77c: dsubu  $zero, $s1, +0     
  0036d780: addu   $v0, $s4, +0       
  0036d784: lw     $v0, +0($v0)          ; GLOBAL 0x3f800000
  0036d788: sll    $v0, $zero, +4     
  0036d78c: jal   0xf035bc40             ; -> FUN_0035bc40
  0036d790: addu   $v0, $s5, +0       
  0036d794: sll    $s0, $zero, +4     
  0036d798: addiu  $v1, $sp, +304     
  0036d79c: addu   $sp, $v0, +0       
  0036d7a0: addiu  $v0, $v0, +160     
  0036d7a4: lw     $v1, +0($v1)       
  0036d7a8: sw     $v1, +0($v0)          ; GLOBAL 0x3f800000
  0036d7ac: andi   $v0, $s0, +255     
  0036d7b0: addiu  $a0, $sp, +320     
  0036d7b4: sll    $v0, $zero, +1     
  0036d7b8: dsubu  $zero, $s6, +0     
  0036d7bc: addu   $v0, $s2, +0       
  0036d7c0: lw     $v0, +0($v0)          ; GLOBAL 0x3f800000
  0036d7c4: sll    $v0, $zero, +4     
  0036d7c8: jal   0xf035bc40             ; -> FUN_0035bc40
  0036d7cc: addu   $v0, $s3, +0       
  0036d7d0: sll    $s0, $zero, +4     
  0036d7d4: addiu  $v1, $sp, +320     
  0036d7d8: addu   $sp, $v0, +0       
  ...
  0036d7f4: bne    $v0, $zero, -132      ; br -> 0x003ad774
