...
; 160 words
  ...
  0042c850: sq     $s4, +64($sp)      
  0042c854: daddu $s4, $a3, $zero     
  0042c858: sq     $s5, +80($sp)      
  0042c85c: addiu  $v1, $s4, +8       
  0042c860: sq     $s3, +48($sp)      
  0042c864: div    $v0, $v1, +0       
  0042c868: sq     $s2, +32($sp)      
  0042c86c: sq     $s0, +0($sp)       
  0042c870: addiu  $a3, $zero, +1     
  0042c874: sq     $ra, +96($sp)      
  0042c878: daddu $s0, $a1, $zero     
  0042c87c: sq     $s1, +16($sp)      
  0042c880: daddu $s3, $a0, $zero     
  0042c884: beql   $v0, $zero, +4        ; br -> 0x0042c88c
  0042c888: break                     
  0042c88c: daddu $s2, $a2, $zero     
  0042c890: daddu $s5, $t0, $zero     
  0042c894: mflo   $zero, $zero, +0   
  0042c898: slt $v0, $a3, $v1         
  0042c89c: beq    $v0, $zero, +36       ; br -> 0x0042c8c4
  0042c8a0: daddu $a1, $zero, $zero   
  0042c8a4: sll $zero, $zero, 0       
  0042c8a8: sll $a3, $a3, 1           
  0042c8ac: slt $v0, $a3, $v1         
  ...
  0042c908: daddu $a1, $v0, $zero     
  0042c90c: slt $v0, $s1, $s2         
  ...
  0042c950: daddu $a1, $v0, $zero     
  0042c954: lq     $ra, +96($sp)      
  0042c958: daddu $v0, $a1, $zero     
  0042c95c: lq     $s5, +80($sp)      
  0042c960: lq     $s4, +64($sp)      
  0042c964: lq     $s3, +48($sp)      
  0042c968: lq     $s2, +32($sp)      
  0042c96c: lq     $s1, +16($sp)      
  0042c970: lq     $s0, +0($sp)       
  0042c974: jr     $ra                
