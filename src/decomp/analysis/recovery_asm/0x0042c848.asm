...
; 160 words
  ...
  0042c878: dsubu  $zero, $a1, +0     
  0042c87c: sw     $s1, +16($sp)      
  0042c880: dsubu  $zero, $a0, +0     
  0042c884: beql   $v0, $zero, +4        ; br -> 0x0042c88c
  0042c888: break   $zero,$zero,$zero 
  0042c88c: dsubu  $zero, $a2, +0     
  0042c890: dsubu  $zero, $t0, +0     
  0042c894: mflo   $zero, $zero, +0   
  0042c898: dadd   $v1, $a3, +0       
  0042c89c: beq    $v0, $zero, +36       ; br -> 0x0042c8c4
  0042c8a0: dsubu  $zero, $zero, +0   
  0042c8a4: sll    $zero, $zero, +0   
  0042c8a8: sll    $a3, $zero, +1     
  0042c8ac: dadd   $v1, $a3, +0       
  0042c8b0: sll    $zero, $zero, +0   
  0042c8b4: sll    $zero, $zero, +0   
  0042c8b8: sll    $zero, $zero, +0   
  0042c8bc: bne    $v0, $zero, -24       ; br -> 0x0046c8a8
  0042c8c0: addiu  $a1, $a1, +1       
  0042c8c4: dsubu  $zero, $s3, +0     
  0042c8c8: jal   0xf042c660             ; -> FUN_0042c660
  0042c8cc: addiu  $s1, $zero, +9     
  0042c8d0: dsubu  $zero, $v0, +0     
  ...
  0042c908: dsubu  $zero, $v0, +0     
  0042c90c: dadd   $s2, $s1, +0       
  0042c910: bnel   $v0, $zero, -36       ; br -> 0x0046c8f0
  0042c914: lw     $a3, +0($s0)       
  0042c918: beq    $zero, $zero, +8      ; br -> 0x0042c924
  0042c91c: addiu  $s0, $s0, +1       
  0042c920: addiu  $s0, $s0, +10      
  0042c924: dadd   $s4, $s1, +0       
  0042c928: beq    $v0, $zero, +40       ; br -> 0x0042c954
  0042c92c: subu   $s1, $s4, +0       
  0042c930: lw     $a3, +0($s0)       
  0042c934: dsubu  $zero, $s3, +0     
  ...
  0042c94c: bne    $s1, $zero, -32       ; br -> 0x0046c930
  0042c950: dsubu  $zero, $v0, +0     
  0042c954: lw     $ra, +96($sp)      
  0042c958: dsubu  $zero, $a1, +0     
  ...
  0042ca20: jr     $ra                
  0042ca24: dsubu  $zero, $zero, +0   
  0042ca28: beql   $v0, $zero, +20       ; br -> 0x0042ca40
  0042ca2c: srl    $v1, $zero, +2     
  0042ca30: srl    $v1, $zero, +1     
