...
; 108 words
  ...
  00161e34: lq     $a3, +0($a3)       
  00161e38: sq     $a3, +0($v1)          ; GLOBAL 0x40000000
  00161e3c: addiu  $t1, $sp, +192     
  00161e40: lq     $v1, +0($v1)          ; GLOBAL 0x40000000
  00161e44: sq     $v1, +0($t1)       
  ...
  00161e68: lq     $v1, +0($v1)          ; GLOBAL 0x40000000
  00161e6c: sq     $v1, +0($a3)       
  ...
  00161e90: lq     $v1, +0($v1)          ; GLOBAL 0x40000000
  00161e94: sq     $v1, +0($a3)       
  ...
  00161ed8: lq     $a1, +0($a1)       
  00161edc: sq     $a1, +0($v1)          ; GLOBAL 0x40000000
  ...
  00161ef8: lq     $a1, +0($a1)       
  00161efc: sq     $a1, +0($v1)          ; GLOBAL 0x40000000
  ...
  00161f1c: lq     $a1, +0($a1)       
  00161f20: sq     $a1, +0($v1)          ; GLOBAL 0x40000000
  ...
  00161f74: lq     $v1, +0($v1)          ; GLOBAL 0x40000000
  00161f78: sq     $v1, +0($v0)          ; GLOBAL 0x3f800000
  00161f7c: jr     $ra                
  00161f80: daddu $v0, $a0, $zero     
