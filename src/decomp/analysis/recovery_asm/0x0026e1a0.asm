...
; 80 words
  ...
  0026e1c4: lw     $t1, +0($t0)       
  0026e1c8: and    $a3, $t1, +0       
  0026e1cc: and    $a0, $t1, +0       
  0026e1d0: srl    $a3, $zero, +24    
  0026e1d4: srl    $a0, $zero, +8     
  0026e1d8: addu   $a0, $a3, +0       
  0026e1dc: andi   $a0, $t1, -256     
  0026e1e0: sll    $a0, $zero, +8     
  0026e1e4: andi   $a0, $t1, +255     
  0026e1e8: addu   $t0, $a3, +0       
  0026e1ec: sll    $a0, $zero, +24    
  0026e1f0: addu   $a3, $a0, +0       
  ...
  0026e204: dsubu  $zero, $zero, +0   
  0026e208: lw     $a0, +12($v1)      
  0026e20c: lui   $v0, 0xff000000     
  0026e210: lui   $t1, 0x00ff0000     
  0026e214: lw     $t2, +8($a0)          ; GLOBAL 0x00ff0008
  0026e218: and    $v0, $t2, +0       
  0026e21c: and    $t1, $t2, +0       
  0026e220: srl    $a3, $zero, +24    
  0026e224: srl    $a0, $zero, +8     
  0026e228: addu   $a0, $a3, +0       
  0026e22c: andi   $a0, $t2, -256     
  0026e230: sll    $a0, $zero, +8     
  0026e234: andi   $a0, $t2, +255     
  0026e238: addu   $t0, $a3, +0       
  0026e23c: sll    $a0, $zero, +24    
  0026e240: addu   $a3, $a0, +0       
  0026e244: daddu  $a3, $a2, +0       
  0026e248: bne    $a0, $zero, +20       ; br -> 0x0026e260
  0026e24c: mult   $a3, $a1, +0       
  0026e250: beq    $zero, $zero, +124    ; br -> 0x0026e2d0
  0026e254: dsubu  $zero, $zero, +0   
  0026e258: beq    $zero, $zero, +120    ; br -> 0x0026e2d4
  0026e25c: addiu  $sp, $sp, +16      
  0026e260: lw     $v1, +16($v1)      
  0026e264: addu   $a0, $a2, +0       
  0026e268: addiu  $a3, $sp, +4       
  0026e26c: sll    $a0, $zero, +2     
  0026e270: addu   $a0, $v1, +0       
  0026e274: lwc1   $zero, +0($v1)     
  0026e278: swc1   $zero, +4($sp)     
  0026e27c: lw     $a1, +0($a3)          ; GLOBAL 0xff000000
  0026e280: and    $v0, $a1, +0       
  0026e284: and    $t1, $a1, +0       
  0026e288: srl    $v1, $zero, +24    
  0026e28c: srl    $v0, $zero, +8     
  0026e290: addu   $v0, $v1, +0       
  0026e294: andi   $v0, $a1, -256     
  0026e298: sll    $v0, $zero, +8     
  0026e29c: andi   $v0, $a1, +255     
  0026e2a0: addu   $a0, $v1, +0       
  0026e2a4: sll    $v0, $zero, +24    
  0026e2a8: addu   $v1, $v0, +0       
