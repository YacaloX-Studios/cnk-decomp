...
; 52 words
  ...
  00432fc4: daddu $t0, $a1, $zero     
  00432fc8: sq     $ra, +0($sp)       
  00432fcc: daddu $a3, $a2, $zero     
  00432fd0: daddu $a1, $a0, $zero     
  00432fd4: lb     $v0, +0($t0)       
  00432fd8: beq    $v0, $zero, +152      ; br -> 0x00433074
  00432fdc: daddu $a2, $t0, $zero     
  00432fe0: lb     $v1, +0($a2)       
