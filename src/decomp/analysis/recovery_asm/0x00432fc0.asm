...
; 52 words
  ...
  00432fc4: dsubu  $zero, $a1, +0     
  00432fc8: sw     $ra, +0($sp)       
  00432fcc: dsubu  $zero, $a2, +0     
  00432fd0: dsubu  $zero, $a0, +0     
  00432fd4: lw     $v0, +0($t0)       
  00432fd8: beq    $v0, $zero, +152      ; br -> 0x00433074
  00432fdc: dsubu  $zero, $t0, +0     
  00432fe0: lw     $v1, +0($a2)       
