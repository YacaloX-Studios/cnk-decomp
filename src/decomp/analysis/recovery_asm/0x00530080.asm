...
; 16 words
  ...
  00530080: lbu    $v1, +3($a0)       
  00530084: addiu  $sp, $sp, -16      
  00530088: sb     $v1, +12($sp)      
  0053008c: lbu    $v1, +2($a0)       
  00530090: sb     $v1, +13($sp)      
  00530094: lbu    $v1, +1($a0)       
  00530098: sb     $v1, +14($sp)      
  0053009c: lbu    $v1, +0($a0)       
  005300a0: sb     $v1, +15($sp)      
