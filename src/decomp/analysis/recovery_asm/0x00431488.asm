...
; 48 words
  ...
  00431494: dsubu  $zero, $a0, +0     
  00431498: sw     $s0, +0($sp)       
  0043149c: dsubu  $zero, $a2, +0     
  004314a0: sw     $ra, +48($sp)      
  004314a4: jal   0xf042c5c0             ; -> FUN_0042c5c0
  004314a8: dsubu  $zero, $a1, +0     
