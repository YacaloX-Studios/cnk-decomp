...
; 48 words
  ...
  0043148c: sq     $s1, +16($sp)      
  00431490: sq     $s2, +32($sp)      
  00431494: daddu $s1, $a0, $zero     
  00431498: sq     $s0, +0($sp)       
  0043149c: daddu $s2, $a2, $zero     
  004314a0: sq     $ra, +48($sp)      
  004314a4: jal   0xf042c5c0             ; -> FUN_0042c5c0
  004314a8: daddu $s0, $a1, $zero     
  ...
  004314e4: daddu $a0, $s1, $zero     
  004314e8: beq    $zero, $zero, +24     ; br -> 0x00431504
  004314ec: sd     $s2, +32472($v0)      ; GLOBAL 0x00657ed8
  004314f0: lui   $v0, 0x00650000     
  004314f4: daddu $a0, $s1, $zero     
  004314f8: beq    $zero, $zero, +8      ; br -> 0x00431504
  004314fc: sd     $s2, +32480($v0)      ; GLOBAL 0x00657ee0
  00431500: daddu $a0, $s1, $zero     
  ...
  00431518: daddu $a0, $s1, $zero     
  0043151c: beq    $zero, $zero, +16     ; br -> 0x00431530
  00431520: sltiu  $v0, $s2, +1       
  00431524: jal   0xf042c620             ; -> FUN_0042c620
  00431528: daddu $a0, $s1, $zero     
  0043152c: daddu $v0, $zero, $zero   
  00431530: lq     $ra, +48($sp)      
  00431534: lq     $s2, +32($sp)      
  00431538: lq     $s1, +16($sp)      
  0043153c: lq     $s0, +0($sp)       
  00431540: jr     $ra                
