...
; 208 words
  ...
  0042c284: sw     $s3, +64($sp)      
  0042c288: sw     $s4, +80($sp)      
  0042c28c: dsubu  $zero, $sp, +0     
  0042c290: sw     $s2, +48($sp)      
  0042c294: dsubu  $zero, $a3, +0     
  0042c298: sw     $s1, +32($sp)      
  0042c29c: dsubu  $zero, $t0, +0     
  0042c2a0: sw     $s0, +16($sp)      
  0042c2a4: dsubu  $zero, $a0, +0     
  0042c2a8: sw     $ra, +96($sp)      
  0042c2ac: dsubu  $zero, $a2, +0     
  0042c2b0: beq    $s0, $zero, +12       ; br -> 0x0042c2c0
  0042c2b4: movn    $a1,$a1,$s3       
  ...
  0042c3dc: dsubu  $zero, $s0, +0     
  0042c3e0: dsubu  $zero, $zero, +0   
  0042c3e4: beq    $s4, $zero, -192      ; br -> 0x0046c328
  0042c3e8: movz    $zero,$v0,$t1     
  0042c3ec: addu   $a2, $s0, +0       
  0042c3f0: addiu  $v1, $zero, +40    
  0042c3f4: lw     $a0, +0($v0)       
  0042c3f8: beq    $a0, $v1, +144        ; br -> 0x0042c48c
  0042c3fc: dsubu  $zero, $v0, +0     
  ...
  0042c544: subu   $s0, $a3, +0       
  0042c548: sw     $v1, +0($s2)       
  0042c54c: addiu  $v0, $v0, +2       
  0042c550: lw     $v1, +0($a3)       
  0042c554: lw     $a0, +1($a3)       
  0042c558: sll    $v1, $zero, +8     
  0042c55c: addu   $a0, $v1, +0       
  0042c560: beq    $zero, $zero, +56     ; br -> 0x0042c59c
  0042c564: sw     $v1, +0($s3)       
  0042c568: addiu  $a3, $t0, +1       
  0042c56c: addiu  $a2, $a2, +1       
  0042c570: daddu  $s4, $a2, +0       
  0042c574: bne    $v0, $zero, -392      ; br -> 0x0046c3f0
  0042c578: addu   $a2, $s0, +0       
  0042c57c: beq    $zero, $zero, +28     ; br -> 0x0042c59c
  0042c580: addiu  $v0, $zero, -1     
  0042c584: beql   $s0, $zero, +20       ; br -> 0x0042c59c
  0042c588: dsubu  $zero, $zero, +0   
  0042c58c: lw     $v0, +0($s0)       
  0042c590: sw     $v0, +0($s3)       
  0042c594: lw     $v0, +0($s0)       
  0042c598: daddu  $v0, $zero, +0     
  0042c59c: lw     $ra, +96($sp)      
  0042c5a0: lw     $s4, +80($sp)      
  0042c5a4: lw     $s3, +64($sp)      
  0042c5a8: lw     $s2, +48($sp)      
  0042c5ac: lw     $s1, +32($sp)      
  0042c5b0: lw     $s0, +16($sp)      
  0042c5b4: jr     $ra                
