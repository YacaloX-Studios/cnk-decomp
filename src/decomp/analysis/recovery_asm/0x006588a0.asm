...
; 120 words
  ...
  006588b4: addu $a2, $a2, $v0        
  006588b8: addiu  $a3, $t0, +18176   
  006588bc: addiu  $a2, $a2, +15      
  006588c0: daddu $a1, $zero, $zero   
  006588c4: sll $zero, $zero, 0       
  006588c8: addu $v0, $a2, $a1        
  006588cc: addu $a0, $a3, $a1        
  006588d0: lbu    $v1, +0($v0)          ; GLOBAL 0xbc000000
  006588d4: addiu  $a1, $a1, +1       
  006588d8: slti   $v0, $a1, +38      
  006588dc: sb     $v1, +0($a0)       
  006588e0: bne    $v0, $zero, -28       ; br -> 0x006588c8
  006588e4: sll $zero, $zero, 0       
  006588e8: beq    $zero, $zero, +8      ; br -> 0x006588f4
  006588ec: ld     $v1, +18176($t0)      ; GLOBAL 0x80074700
  006588f0: ld     $v1, +18176($t0)      ; GLOBAL 0x80074700
  ...
  0065894c: and $v0, $v0, $a0         
  00658950: and $v0, $v0, $v1         
  00658954: sd     $v0, +18176($t0)      ; GLOBAL 0x80074700
  00658958: jr     $ra                
  0065895c: sll $zero, $zero, 0       
  00658960: addu $a3, $a1, $a2        
  00658964: sltiu  $v0, $a3, +129     
  00658968: bne    $v0, $zero, +32       ; br -> 0x0065898c
  0065896c: daddu $t2, $a0, $zero     
  ...
  00658980: subu $a1, $v0, $a2        
  00658984: addiu  $a2, $zero, +128   
  00658988: daddu $a1, $zero, $zero   
  0065898c: addu $a1, $a1, $a2        
  00658990: sltu $v0, $a2, $a1        
  00658994: beq    $v0, $zero, +60       ; br -> 0x006589d4
  00658998: daddu $t0, $zero, $zero   
  0065899c: daddu $a3, $a1, $zero     
  006589a0: lui   $t1, 0x80070000     
  006589a4: lui   $a1, 0x80070000     
  006589a8: addiu  $v0, $a1, +18352   
  006589ac: addu $a0, $t2, $t0        
  006589b0: addu $v0, $a2, $v0        
  006589b4: addiu  $t0, $t0, +1       
  006589b8: lbu    $v1, +0($v0)          ; GLOBAL 0xbc000000
  006589bc: addiu  $a2, $a2, +1       
  006589c0: sltu $v0, $a2, $a3        
  006589c4: bne    $v0, $zero, -32       ; br -> 0x006589a8
  006589c8: sb     $v1, +0($a0)       
  006589cc: beq    $zero, $zero, +12     ; br -> 0x006589dc
  006589d0: ld     $v1, +18176($t1)      ; GLOBAL 0x80074700
  006589d4: lui   $t1, 0x80070000     
  006589d8: ld     $v1, +18176($t1)      ; GLOBAL 0x80074700
  ...
  00658a2c: subu $v1, $v0, $a2        
  00658a30: addiu  $a2, $zero, +128   
  00658a34: daddu $v1, $zero, $zero   
  00658a38: addu $a1, $v1, $a2        
  00658a3c: sltu $v0, $a2, $a1        
  00658a40: beq    $v0, $zero, +48       ; br -> 0x00658a74
  00658a44: daddu $a3, $zero, $zero   
  00658a48: lui   $t0, 0x80070000     
  00658a4c: sll $zero, $zero, 0       
  00658a50: addu $v0, $t1, $a3        
  00658a54: addiu  $v1, $t0, +18352   
  00658a58: addu $v1, $a2, $v1        
  00658a5c: lbu    $a0, +0($v0)          ; GLOBAL 0xbc000000
  00658a60: addiu  $a2, $a2, +1       
  00658a64: addiu  $a3, $a3, +1       
  00658a68: sltu $v0, $a2, $a1        
  00658a6c: bne    $v0, $zero, -32       ; br -> 0x00658a50
  00658a70: sb     $a0, +0($v1)          ; GLOBAL 0xffff0000
  00658a74: jr     $ra                
