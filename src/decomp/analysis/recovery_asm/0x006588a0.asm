...
; 120 words
  ...
  00658988: dsubu $a1, $zero, $zero   
  0065898c: addu $a1, $a1, $a2        
  00658990: daddu $v0, $a2, $a1       
  00658994: beq    $v0, $zero, +60       ; br -> 0x006589d4
  00658998: dsubu $t0, $zero, $zero   
  0065899c: dsubu $a3, $a1, $zero     
  ...
  00658a34: dsubu $v1, $zero, $zero   
  00658a38: addu $a1, $v1, $a2        
  00658a3c: daddu $v0, $a2, $a1       
  00658a40: beq    $v0, $zero, +48       ; br -> 0x00658a74
  00658a44: dsubu $a3, $zero, $zero   
