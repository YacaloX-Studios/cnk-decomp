...
; 80 words
  ...
  0026e304: lw     $t1, +0($t0)       
  0026e308: and    $a3, $t1, +0       
  0026e30c: and    $a0, $t1, +0       
  0026e310: srl    $a3, $zero, +24    
  0026e314: srl    $a0, $zero, +8     
  0026e318: addu   $a0, $a3, +0       
  0026e31c: andi   $a0, $t1, -256     
  0026e320: sll    $a0, $zero, +8     
  0026e324: andi   $a0, $t1, +255     
  0026e328: addu   $t0, $a3, +0       
  0026e32c: sll    $a0, $zero, +24    
  0026e330: addu   $a3, $a0, +0       
  ...
  0026e344: dsubu  $zero, $zero, +0   
  0026e348: lw     $a0, +12($v1)      
  0026e34c: lui   $v0, 0xff000000     
  0026e350: lui   $t1, 0x00ff0000     
  0026e354: lw     $t2, +8($a0)          ; GLOBAL 0x00ff0008
  0026e358: and    $v0, $t2, +0       
  0026e35c: and    $t1, $t2, +0       
  0026e360: srl    $a3, $zero, +24    
  0026e364: srl    $a0, $zero, +8     
  0026e368: addu   $a0, $a3, +0       
  0026e36c: andi   $a0, $t2, -256     
  0026e370: sll    $a0, $zero, +8     
  0026e374: andi   $a0, $t2, +255     
  0026e378: addu   $t0, $a3, +0       
  0026e37c: sll    $a0, $zero, +24    
  0026e380: addu   $a3, $a0, +0       
  0026e384: daddu  $a3, $a2, +0       
  0026e388: bne    $a0, $zero, +20       ; br -> 0x0026e3a0
  0026e38c: mult   $a3, $a1, +0       
  0026e390: beq    $zero, $zero, +124    ; br -> 0x0026e410
  0026e394: dsubu  $zero, $zero, +0   
  0026e398: beq    $zero, $zero, +120    ; br -> 0x0026e414
  0026e39c: addiu  $sp, $sp, +16      
  0026e3a0: lw     $v1, +16($v1)      
  0026e3a4: addu   $a0, $a2, +0       
  0026e3a8: addiu  $a3, $sp, +4       
  0026e3ac: sll    $a0, $zero, +2     
  0026e3b0: addu   $a0, $v1, +0       
  0026e3b4: lwc1   $zero, +0($v1)     
  0026e3b8: swc1   $zero, +4($sp)     
  0026e3bc: lw     $a1, +0($a3)          ; GLOBAL 0xff000000
  0026e3c0: and    $v0, $a1, +0       
  0026e3c4: and    $t1, $a1, +0       
  0026e3c8: srl    $v1, $zero, +24    
  0026e3cc: srl    $v0, $zero, +8     
  0026e3d0: addu   $v0, $v1, +0       
  0026e3d4: andi   $v0, $a1, -256     
  0026e3d8: sll    $v0, $zero, +8     
  0026e3dc: andi   $v0, $a1, +255     
  0026e3e0: addu   $a0, $v1, +0       
  0026e3e4: sll    $v0, $zero, +24    
  0026e3e8: addu   $v1, $v0, +0       
