...
; 180 words
  ...
  0026e444: lw     $t1, +0($t0)       
  0026e448: and    $a3, $t1, +0       
  0026e44c: and    $a0, $t1, +0       
  0026e450: srl    $a3, $zero, +24    
  0026e454: srl    $a0, $zero, +8     
  0026e458: addu   $a0, $a3, +0       
  0026e45c: andi   $a0, $t1, -256     
  0026e460: sll    $a0, $zero, +8     
  0026e464: andi   $a0, $t1, +255     
  0026e468: addu   $t0, $a3, +0       
  0026e46c: sll    $a0, $zero, +24    
  0026e470: addu   $a3, $a0, +0       
  ...
  0026e484: dsubu  $zero, $zero, +0   
  0026e488: lw     $a0, +12($v1)      
  0026e48c: lui   $v0, 0xff000000     
  0026e490: lui   $t1, 0x00ff0000     
  0026e494: lw     $t2, +8($a0)          ; GLOBAL 0x00ff0008
  0026e498: and    $v0, $t2, +0       
  0026e49c: and    $t1, $t2, +0       
  0026e4a0: srl    $a3, $zero, +24    
  0026e4a4: srl    $a0, $zero, +8     
  0026e4a8: addu   $a0, $a3, +0       
  0026e4ac: andi   $a0, $t2, -256     
  0026e4b0: sll    $a0, $zero, +8     
  0026e4b4: andi   $a0, $t2, +255     
  0026e4b8: addu   $t0, $a3, +0       
  0026e4bc: sll    $a0, $zero, +24    
  0026e4c0: addu   $a3, $a0, +0       
  0026e4c4: daddu  $a3, $a2, +0       
  0026e4c8: bne    $a0, $zero, +20       ; br -> 0x0026e4e0
  0026e4cc: mult   $a3, $a1, +0       
  0026e4d0: beq    $zero, $zero, +124    ; br -> 0x0026e550
  0026e4d4: dsubu  $zero, $zero, +0   
  0026e4d8: beq    $zero, $zero, +120    ; br -> 0x0026e554
  0026e4dc: addiu  $sp, $sp, +16      
  0026e4e0: lw     $v1, +16($v1)      
  0026e4e4: addu   $a0, $a2, +0       
  0026e4e8: addiu  $a3, $sp, +4       
  0026e4ec: sll    $a0, $zero, +2     
  0026e4f0: addu   $a0, $v1, +0       
  0026e4f4: lwc1   $zero, +0($v1)     
  0026e4f8: swc1   $zero, +4($sp)     
  0026e4fc: lw     $a1, +0($a3)          ; GLOBAL 0xff000000
  0026e500: and    $v0, $a1, +0       
  0026e504: and    $t1, $a1, +0       
  0026e508: srl    $v1, $zero, +24    
  0026e50c: srl    $v0, $zero, +8     
  0026e510: addu   $v0, $v1, +0       
  0026e514: andi   $v0, $a1, -256     
  0026e518: sll    $v0, $zero, +8     
  0026e51c: andi   $v0, $a1, +255     
  0026e520: addu   $a0, $v1, +0       
  0026e524: sll    $v0, $zero, +24    
  0026e528: addu   $v1, $v0, +0       
  ...
  0026e580: and    $a1, $t2, +0       
  0026e584: and    $v1, $t2, +0       
  0026e588: srl    $a2, $zero, +24    
  0026e58c: srl    $v0, $zero, +8     
  0026e590: addu   $v0, $a2, +0       
  0026e594: andi   $v0, $t2, -256     
  0026e598: sll    $v0, $zero, +8     
  0026e59c: andi   $v0, $t2, +255     
  0026e5a0: addu   $t1, $a2, +0       
  0026e5a4: sll    $v0, $zero, +24    
  0026e5a8: addu   $a2, $v0, +0       
  0026e5ac: sw     $v0, +12($a0)         ; GLOBAL 0x00ff000c
  0026e5b0: lw     $t2, +8($t3)       
  0026e5b4: lw     $v0, +4($a0)          ; GLOBAL 0x00ff0004
  0026e5b8: and    $a1, $t2, +0       
  0026e5bc: and    $v1, $t2, +0       
  0026e5c0: addiu  $v0, $v0, +12      
  0026e5c4: srl    $t1, $zero, +24    
  0026e5c8: srl    $a2, $zero, +8     
  0026e5cc: sw     $v0, +16($a0)         ; GLOBAL 0x00ff0010
  0026e5d0: addu   $a2, $t1, +0       
  0026e5d4: andi   $v0, $t2, -256     
  0026e5d8: sll    $v0, $zero, +8     
  0026e5dc: andi   $v0, $t2, +255     
  0026e5e0: addu   $t1, $a2, +0       
  0026e5e4: sll    $v0, $zero, +24    
  0026e5e8: addu   $a2, $v0, +0       
  0026e5ec: daddu  $v0, $zero, +0     
  0026e5f0: beq    $at, $zero, +204      ; br -> 0x0026e6c0
  0026e5f4: dsubu  $zero, $zero, +0   
  0026e5f8: dsubu  $zero, $zero, +0   
  0026e5fc: lw     $t2, +16($a0)         ; GLOBAL 0x00ff0010
  0026e600: addiu  $t0, $t0, +1       
  0026e604: daddu  $v0, $t0, +0       
  0026e608: addu   $a2, $t2, +0       
  0026e60c: lw     $t5, +0($t6)       
  0026e610: and    $a1, $t5, +0       
  0026e614: and    $v1, $t5, +0       
  0026e618: srl    $t3, $zero, +24    
  0026e61c: srl    $t2, $zero, +8     
  0026e620: addu   $t2, $t3, +0       
  0026e624: andi   $t2, $t5, -256     
  0026e628: sll    $t2, $zero, +8     
  0026e62c: andi   $t2, $t5, +255     
  0026e630: addu   $t4, $t3, +0       
  0026e634: sll    $t2, $zero, +24    
  0026e638: addu   $t3, $t2, +0       
  0026e63c: sw     $t2, +0($t6)       
  0026e640: lw     $t2, +16($a0)         ; GLOBAL 0x00ff0010
  0026e644: addu   $a2, $t2, +0       
  0026e648: lw     $t5, +4($t6)       
  0026e64c: and    $a1, $t5, +0       
  0026e650: and    $v1, $t5, +0       
  0026e654: srl    $t3, $zero, +24    
  0026e658: srl    $t2, $zero, +8     
  0026e65c: addu   $t2, $t3, +0       
  0026e660: andi   $t2, $t5, -256     
  0026e664: sll    $t2, $zero, +8     
  0026e668: andi   $t2, $t5, +255     
  0026e66c: addu   $t4, $t3, +0       
  0026e670: sll    $t2, $zero, +24    
  0026e674: addu   $t3, $t2, +0       
  0026e678: sw     $t2, +4($t6)       
  0026e67c: lw     $t2, +16($a0)         ; GLOBAL 0x00ff0010
  0026e680: addu   $a2, $t2, +0       
  0026e684: lw     $t5, +8($t6)       
  0026e688: addiu  $a2, $a2, +12      
  0026e68c: and    $a1, $t5, +0       
  0026e690: and    $v1, $t5, +0       
  0026e694: srl    $t3, $zero, +24    
  0026e698: srl    $t2, $zero, +8     
  0026e69c: addu   $t2, $t3, +0       
  0026e6a0: andi   $t2, $t5, -256     
  0026e6a4: sll    $t2, $zero, +8     
  0026e6a8: andi   $t2, $t5, +255     
  0026e6ac: addu   $t4, $t3, +0       
  0026e6b0: sll    $t2, $zero, +24    
  0026e6b4: addu   $t3, $t2, +0       
  0026e6b8: bne    $t1, $zero, -192      ; br -> 0x002ae5fc
  0026e6bc: sw     $t2, +8($t6)       
  0026e6c0: addiu  $a1, $v0, +1       
  0026e6c4: sll    $a1, $zero, +1     
  0026e6c8: dsubu  $zero, $a0, +0     
  0026e6cc: addu   $a1, $v1, +0       
  0026e6d0: sll    $v1, $zero, +2     
  0026e6d4: subu   $a1, $a3, +0       
  0026e6d8: sw     $v1, +8($a0)          ; GLOBAL 0x00ff0008
  0026e6dc: lw     $v1, +4($a0)          ; GLOBAL 0x00ff0004
  0026e6e0: addu   $a1, $v1, +0       
  0026e6e4: jr     $ra                
