...
; 80 words
  ...
  004f9eb8: dsubu  $zero, $zero, +0   
  004f9ebc: dsubu  $zero, $zero, +0   
  004f9ec0: lw     $v1, +16($v1)      
  004f9ec4: addu   $a2, $v1, +0       
  004f9ec8: lw     $v1, +0($a2)       
  004f9ecc: andi   $a1, $v1, +127     
  004f9ed0: addiu  $a2, $a2, +1       
  004f9ed4: sllv   $a1, $t0, +0       
  004f9ed8: andi   $v1, $v1, +128     
  004f9edc: beq    $v1, $zero, +12       ; br -> 0x004f9eec
  004f9ee0: or     $a1, $t1, +0       
  004f9ee4: beq    $zero, $zero, -32     ; br -> 0x00539ec8
  ...
  004f9f28: sw     $v1, +0($a0)       
  004f9f2c: dsubu  $zero, $zero, +0   
  004f9f30: dsubu  $zero, $zero, +0   
  004f9f34: lw     $v1, +0($t3)       
  004f9f38: andi   $a1, $v1, +127     
  004f9f3c: addiu  $t3, $t3, +1       
  004f9f40: sllv   $a1, $a2, +0       
  004f9f44: andi   $v1, $v1, +128     
  004f9f48: beq    $v1, $zero, +12       ; br -> 0x004f9f58
  004f9f4c: or     $a1, $t0, +0       
  004f9f50: beq    $zero, $zero, -32     ; br -> 0x00539f34
  ...
  004f9f6c: lw     $a2, +2($t3)       
  004f9f70: dsubu  $zero, $zero, +0   
  004f9f74: lw     $a1, +1($t3)       
  004f9f78: lw     $v1, +0($t3)       
  004f9f7c: sll    $t0, $zero, +24    
  004f9f80: sll    $a2, $zero, +16    
  004f9f84: or     $a2, $t0, +0       
  004f9f88: sll    $a1, $zero, +8     
  004f9f8c: or     $a2, $a1, +0       
  004f9f90: or     $a1, $v1, +0       
  004f9f94: sw     $v1, +12($sp)      
  004f9f98: sw     $zero, +0($a3)     
  004f9f9c: lw     $a2, +0($t2)       
  004f9fa0: dsubu  $zero, $t2, +0     
  004f9fa4: lw     $a1, +0($a3)       
  004f9fa8: andi   $a2, $a2, +127     
  004f9fac: sllv   $a2, $t1, +0       
  004f9fb0: or     $a2, $a1, +0       
  004f9fb4: sw     $a1, +0($a3)       
  004f9fb8: lw     $v1, +0($v1)       
  ...
  004f9fc8: beq    $zero, $zero, -48     ; br -> 0x00539f9c
