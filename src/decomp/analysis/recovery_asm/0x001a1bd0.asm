...
; 92 words
  ...
  001a1bd4: dsubu $a1, $zero, $zero   
  001a1bd8: addiu  $v1, $sp, +0       
  001a1bdc: dsubu $a3, $v1, $zero     
  001a1be0: lw     $a2, +8($a0)       
  ...
  001a1c08: dadd $at, $zero, $a1      
  001a1c0c: beq    $at, $zero, +96       ; br -> 0x001a1c70
  001a1c10: dsubu $t4, $zero, $zero   
  001a1c14: dsubu $t2, $v1, $zero     
  001a1c18: addiu  $t3, $t4, +1       
  001a1c1c: dadd $at, $t3, $a1        
