...
; 92 words
  ...
  001a1bd4: dsubu  $zero, $zero, +0   
  001a1bd8: addiu  $v1, $sp, +0       
  001a1bdc: dsubu  $zero, $v1, +0     
  001a1be0: lw     $a2, +8($a0)       
  ...
  001a1cdc: dadd   $a1, $t1, +0       
  001a1ce0: bne    $a0, $zero, -60       ; br -> 0x001e1ca8
  001a1ce4: addiu  $t0, $t0, +4       
  001a1ce8: lw     $a0, +0($v1)       
  001a1cec: sw     $t2, +24($a0)      
  001a1cf0: lw     $a0, +0($v1)       
  001a1cf4: lw     $a0, +20($a0)      
  ...
  001a1d0c: dadd   $a1, $a3, +0       
  001a1d10: bne    $a0, $zero, -148      ; br -> 0x001e1c80
  001a1d14: addiu  $v1, $v1, +4       
  001a1d18: beq    $zero, $zero, +20     ; br -> 0x001a1d30
  001a1d1c: sll    $zero, $zero, +0   
  001a1d20: sw     $t0, +0($t2)       
  001a1d24: beq    $zero, $zero, -216    ; br -> 0x001e1c50
  001a1d28: sw     $a3, +0($t1)       
