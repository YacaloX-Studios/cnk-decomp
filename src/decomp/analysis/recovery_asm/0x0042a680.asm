...
; 50 words
  ...
  0042a684: sq     $s0, +112($sp)     
  0042a688: sq     $ra, +128($sp)     
  0042a68c: daddu $s0, $a0, $zero     
  0042a690: lhu    $v0, +12($s0)      
