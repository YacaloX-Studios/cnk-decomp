...
; 56 words
  ...
  00429b84: sq     $s1, +16($sp)      
  00429b88: sq     $ra, +32($sp)      
  00429b8c: daddu $s1, $a0, $zero     
  00429b90: sq     $s0, +0($sp)       
  ...
  00429c00: daddu $v0, $zero, $zero   
  00429c04: beq    $zero, $zero, +68     ; br -> 0x00429c4c
  00429c08: sw     $v1, +0($s1)       
  00429c0c: addiu  $v0, $zero, +1     
  00429c10: addiu  $v1, $zero, -1     
  00429c14: sh     $v0, +12($a0)      
  00429c18: sh     $v1, +14($a0)      
  00429c1c: daddu $v0, $a0, $zero     
  ...
  00429c4c: lq     $ra, +32($sp)      
  00429c50: lq     $s1, +16($sp)      
  00429c54: lq     $s0, +0($sp)       
  00429c58: jr     $ra                
