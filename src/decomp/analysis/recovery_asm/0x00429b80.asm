...
; 56 words
  ...
  00429bcc: regimm $v1, $at, -24         ; br -> 0x00469bb8
  00429bd0: addiu  $a0, $a0, +88      
  00429bd4: lw     $v0, +0($s0)       
  00429bd8: bnel   $v0, $zero, -52       ; br -> 0x00469ba8
  00429bdc: lw     $s0, +0($s0)       
  00429be0: dsubu  $zero, $s1, +0     
  00429be4: jal   0xf0429b08             ; -> FUN_00429b08
  00429be8: addiu  $a1, $zero, +4     
  00429bec: beq    $v0, $zero, +12       ; br -> 0x00429bfc
  00429bf0: sw     $v0, +0($s0)       
  00429bf4: beq    $zero, $zero, -80     ; br -> 0x00469ba8
  00429bf8: lw     $s0, +0($s0)       
  00429bfc: addiu  $v1, $zero, +12    
  00429c00: dsubu  $zero, $zero, +0   
