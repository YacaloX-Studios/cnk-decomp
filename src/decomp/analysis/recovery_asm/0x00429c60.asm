...
; 36 words
  ...
  00429cd8: lq     $ra, +32($sp)      
  00429cdc: lq     $s1, +16($sp)      
  00429ce0: lq     $s0, +0($sp)       
  00429ce4: jr     $ra                
