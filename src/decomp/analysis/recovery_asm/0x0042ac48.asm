...
; 26 words
  ...
  0042ac4c: dsubu $v0, $a1, $zero     
  0042ac50: sw     $s0, +0($sp)       
  0042ac54: dsubu $a3, $a2, $zero     
  0042ac58: sw     $ra, +16($sp)      
  0042ac5c: dsubu $s0, $a0, $zero     
  0042ac60: dsubu $a2, $v0, $zero     
  0042ac64: lw     $a0, +84($s0)      
  0042ac68: jal   0xf04297c0             ; -> FUN_004297c0
  0042ac6c: lw     $a1, +14($s0)      
  0042ac70: dsubu $a0, $v0, $zero     
  0042ac74: addiu  $v0, $zero, -1     
  0042ac78: bne    $a0, $v0, +12         ; br -> 0x0042ac88
  0042ac7c: lw     $v0, +12($s0)      
  ...
  0042ac98: sw     $v0, +12($s0)      
  0042ac9c: lw     $ra, +16($sp)      
  0042aca0: dsubu $v0, $a0, $zero     
  0042aca4: lw     $s0, +0($sp)       
  0042aca8: jr     $ra                
