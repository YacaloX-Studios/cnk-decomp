...
; 114 words
  ...
  0042ce24: dsubu $s5, $a0, $zero     
  0042ce28: sw     $s2, +32($sp)      
  0042ce2c: dsubu $s4, $a2, $zero     
  0042ce30: sw     $s1, +16($sp)      
  0042ce34: dsubu $s2, $a1, $zero     
  0042ce38: sw     $s0, +0($sp)       
  ...
  0042cfc8: daddu $a0, $v0, $a0       
  0042cfcc: daddu $v0, $a3, $a2       
  0042cfd0: bne    $v0, $zero, -28       ; br -> 0x0042cfb8
  0042cfd4: addiu  $a2, $a2, -4       
  0042cfd8: jr     $ra                
  0042cfdc: dsubu $v0, $zero, $zero   
