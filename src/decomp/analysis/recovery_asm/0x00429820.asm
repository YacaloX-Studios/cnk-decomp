...
; 24 words
  ...
  00429824: sq     $s0, +0($sp)       
  00429828: daddu $s0, $a0, $zero     
  0042982c: sq     $s1, +16($sp)      
  00429830: daddu $a0, $a1, $zero     
  00429834: lui   $s1, 0x00650000     
  00429838: daddu $a1, $a2, $zero     
  0042983c: sq     $ra, +32($sp)      
  00429840: sw     $zero, +30552($s1)    ; GLOBAL 0x00657758
  00429844: jal   0xf043d1a0             ; -> 0x0043d1a0
  00429848: daddu $a2, $a3, $zero     
  0042984c: daddu $v1, $v0, $zero     
  00429850: addiu  $v0, $zero, -1     
  00429854: bne    $v1, $v0, +20         ; br -> 0x0042986c
  00429858: lq     $ra, +32($sp)      
  0042985c: lw     $v0, +30552($s1)      ; GLOBAL 0x00657758
  00429860: bnel   $v0, $zero, +8        ; br -> 0x0042986c
  00429864: sw     $v0, +0($s0)       
  00429868: lq     $ra, +32($sp)      
  0042986c: daddu $v0, $v1, $zero     
  00429870: lq     $s1, +16($sp)      
  00429874: lq     $s0, +0($sp)       
  00429878: jr     $ra                
