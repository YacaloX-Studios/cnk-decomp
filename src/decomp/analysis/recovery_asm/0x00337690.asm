...
; 148 words
  ...
  003376a8: sd     $ra, +96($sp)      
  003376ac: addiu  $v1, $sp, +180     
  003376b0: sq     $s4, +80($sp)      
  003376b4: sq     $s3, +64($sp)      
  003376b8: daddu $s4, $a0, $zero     
  003376bc: sq     $s2, +48($sp)      
  003376c0: lui   $a0, 0x3f800000     
  003376c4: sq     $s1, +32($sp)      
  003376c8: fmove  $zero,$a0,$a0      
  003376cc: sq     $s0, +16($sp)      
  003376d0: daddu $s3, $a1, $zero     
  003376d4: swc1   $s4, +0($sp)       
  003376d8: daddu $s2, $a2, $zero     
  003376dc: sw     $v0, +176($sp)     
  003376e0: f10.6  $t5,$s0,$zero      
  003376e4: lui   $v0, 0x006a0000     
  003376e8: daddu $s1, $a3, $zero     
  003376ec: addiu  $v0, $v0, +8480    
  003376f0: sw     $a0, +0($v1)       
  003376f4: addiu  $s0, $sp, +192     
  003376f8: lq     $a1, +0($v0)          ; GLOBAL 0x006a0000
  003376fc: lq     $a0, +16($v0)         ; GLOBAL 0x006a0010
  00337700: sq     $a1, +0($s0)       
  00337704: sq     $a0, +16($s0)      
  00337708: lq     $a1, +32($v0)         ; GLOBAL 0x006a0020
  0033770c: lq     $a0, +48($v0)         ; GLOBAL 0x006a0030
  00337710: sq     $a1, +32($s0)      
  00337714: sq     $a0, +48($s0)      
  ...
  003378b4: ld     $ra, +96($sp)      
  003378b8: lwc1   $s4, +0($sp)       
  003378bc: lq     $s4, +80($sp)      
  003378c0: lq     $s3, +64($sp)      
  003378c4: lq     $s2, +48($sp)      
  003378c8: lq     $s1, +32($sp)      
  003378cc: lq     $s0, +16($sp)      
  003378d0: jr     $ra                
