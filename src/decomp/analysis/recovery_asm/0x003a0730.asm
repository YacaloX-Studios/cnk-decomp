...
; 176 words
  ...
  003a09d8: regimm $a0, $at, -52         ; br -> 0x003a09a8
  003a09dc: addiu  $v1, $v1, +32      
  003a09e0: dsubu $v0, $zero, $zero   
  003a09e4: jr     $ra                
