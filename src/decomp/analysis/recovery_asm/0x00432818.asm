...
; 40 words
  ...
  0043283c: daddu $a3, $zero, $zero   
  00432840: addiu  $t3, $v0, +32552   
  00432844: daddu $t0, $zero, $zero   
  ...
  0043289c: daddu $a0, $t1, $zero     
  004328a0: jal   0xf04327a0             ; -> FUN_004327a0
  004328a4: sb     $zero, +0($v0)        ; GLOBAL 0x00650000
  004328a8: lq     $ra, +0($sp)       
  004328ac: jr     $ra                
