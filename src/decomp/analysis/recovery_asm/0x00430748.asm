...
; 190 words
  ...
  00430750: sw     $s0, +0($sp)       
  00430754: dsubu  $zero, $a0, +0     
  00430758: dsubu  $zero, $a1, +0     
  ...
  00430784: and    $v0, $a2, +0       
  00430788: addiu  $t3, $a1, +31440   
  0043078c: addu   $t1, $t2, +0       
  00430790: ori    $v1, $v1, -4       
  00430794: lw     $a0, +4($a3)       
  00430798: dsubu  $zero, $a1, +0     
  0043079c: lw     $v0, +8($t3)       
  004307a0: bne    $a3, $v0, +112        ; br -> 0x00430814
  004307a4: and    $v1, $a0, +0       
  004307a8: andi   $v0, $a2, +1       
  004307ac: bne    $v0, $zero, +32       ; br -> 0x004307d0
  004307b0: addu   $a0, $t1, +0       
  004307b4: lw     $a1, -8($s0)       
  004307b8: subu   $a1, $t2, +0       
  004307bc: addu   $a1, $t1, +0       
  ...
  004308a0: dsubu  $zero, $v1, +0     
  004308a4: sw     $t0, +12($a2)      
  004308a8: sw     $a2, +8($t0)       
  004308ac: ori    $v0, $t1, +1       
  004308b0: addu   $t1, $t2, +0       
  004308b4: sw     $v0, +4($t2)       
  ...
  004308c8: srl    $t1, $zero, +3     
  004308cc: addiu  $v0, $zero, -1     
  004308d0: dadd   $a3, $v0, +0       
  004308d4: addiu  $v1, $a3, +3       
  004308d8: movn    $a3,$v0,$v1       
  004308dc: addiu  $a1, $t5, +31440   
  004308e0: sra    $v1, $zero, +2     
  ...
  004309d4: and    $v0, $v1, +0       
  004309d8: daddu  $v1, $t1, +0       
  ...
  004309f8: lw     $v0, +4($a2)       
  004309fc: and    $v1, $v0, +0       
  00430a00: daddu  $v0, $t1, +0       
  00430a04: bnel   $v0, $zero, -24       ; br -> 0x004709f0
  00430a08: lw     $a2, +8($a2)       
