...
; 176 words
  ...
  003a0a98: daddu $t1, $zero, $zero   
  003a0a9c: daddu $t2, $zero, $zero   
  003a0aa0: addu $t0, $v1, $t2        
  003a0aa4: lwc1   $zero, +0($t0)     
  003a0aa8: addiu  $t1, $t1, +1       
  003a0aac: slt $at, $v0, $t1         
  ...
  003a0b2c: daddu $t6, $v0, $zero     
  003a0b30: daddu $t5, $a3, $zero     
  ...
  003a0ba8: daddu $t1, $a1, $zero     
  003a0bac: regimm $a3, $zero, +156      ; br -> 0x003a0c4c
  003a0bb0: daddu $t0, $v1, $zero     
