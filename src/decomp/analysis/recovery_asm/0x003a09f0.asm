...
; 176 words
  ...
  003a0c90: regimm $a0, $at, -44         ; br -> 0x003e0c68
  003a0c94: addiu  $v1, $v1, +16      
  003a0c98: dsubu  $zero, $zero, +0   
  003a0c9c: jr     $ra                
