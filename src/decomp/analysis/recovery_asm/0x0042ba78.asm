...
; 34 words
  ...
  0042ba80: sq     $ra, +0($sp)       
  0042ba84: daddu $a2, $a1, $zero     
  0042ba88: lw     $v1, +30548($v0)      ; GLOBAL 0x00657754
  0042ba8c: daddu $a1, $a0, $zero     
  ...
  0042bab8: daddu $a3, $a0, $zero     
  0042babc: ori    $v1, $v1, -1       
  0042bac0: addiu  $v0, $zero, +520   
  0042bac4: sq     $ra, +96($sp)      
  0042bac8: sw     $v1, +20($sp)      
  0042bacc: daddu $a0, $sp, $zero     
  0042bad0: sw     $v1, +8($sp)       
  0042bad4: sh     $v0, +12($sp)      
  0042bad8: sw     $a3, +16($sp)      
  0042badc: sw     $t0, +84($sp)      
  0042bae0: jal   0xf0432fc0             ; -> FUN_00432fc0
  0042bae4: sw     $a3, +0($sp)       
  0042bae8: lw     $v1, +0($sp)       
  0042baec: lq     $ra, +96($sp)      
  0042baf0: sb     $zero, +0($v1)        ; GLOBAL 0x7fff0000
  0042baf4: jr     $ra                
