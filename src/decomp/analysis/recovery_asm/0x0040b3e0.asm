...
; 84 words
  ...
  0040b40c: dsubu  $zero, $v1, +0     
  0040b410: lui   $at, 0x00700000     
  0040b414: subu   $a1, $a2, +0       
  0040b418: sw     $v0, +11040($at)      ; GLOBAL 0x00702b20
  0040b41c: srl    $v1, $zero, +3     
