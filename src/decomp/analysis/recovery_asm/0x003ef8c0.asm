...
; 220 words
  ...
  003ef968: sh     $a1, -14378($at)      ; GLOBAL 0x0070c7d6
  003ef96c: lui   $t0, 0x00650000     
  003ef970: lui   $at, 0x00700000     
  003ef974: lui   $a3, 0x00650000     
  003ef978: sb     $a0, -14103($at)      ; GLOBAL 0x0070c8e9
  ...
  003efbe0: sb     $v1, +0($a2)          ; GLOBAL 0x00700000
  003efbe4: sw     $a3, -15504($at)      ; GLOBAL 0x0070c370
  003efbe8: lui   $at, 0x00700000     
  003efbec: sh     $a1, -14666($at)      ; GLOBAL 0x0070c6b6
  003efbf0: lui   $at, 0x00700000     
  003efbf4: sb     $a0, -14247($at)      ; GLOBAL 0x0070c859
  003efbf8: lq     $fp, +128($sp)     
  003efbfc: lq     $s7, +112($sp)     
  003efc00: lq     $s6, +96($sp)      
  003efc04: lq     $s5, +80($sp)      
  003efc08: lq     $s4, +64($sp)      
  003efc0c: lq     $s3, +48($sp)      
  003efc10: lq     $s2, +32($sp)      
  003efc14: lq     $s1, +16($sp)      
  003efc18: lq     $s0, +0($sp)       
  003efc1c: jr     $ra                
