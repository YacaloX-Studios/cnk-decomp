...
; 128 words
  ...
  00157528: nor    $zero, $v0, +0     
  0015752c: daddu  $v0, $zero, +0     
  ...
  001575f0: sll    $t3, $zero, +2     
  001575f4: addiu  $v0, $v0, -10096   
  001575f8: addu   $t3, $t2, +0       
  001575fc: sll    $t3, $zero, +2     
  00157600: addu   $t2, $t3, +0       
  00157604: sll    $t2, $zero, +2     
  00157608: addu   $t2, $t1, +0       
  ...
  00157678: sll    $a1, $zero, +2     
  0015767c: addu   $a1, $v0, +0       
  00157680: sw     $v1, +40($a0)      
  00157684: lw     $v0, +36($a0)      
  00157688: sll    $a1, $zero, +2     
  0015768c: addu   $v1, $a1, +0       
  00157690: sll    $v1, $zero, +2     
  00157694: jr     $ra                
  00157698: addu   $v1, $v0, +0       
