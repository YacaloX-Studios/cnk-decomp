...
; 38 words
  ...
  0042a5f4: dsubu  $zero, $a1, +0     
  0042a5f8: sw     $s2, +32($sp)      
  0042a5fc: dsubu  $zero, $zero, +0   
  ...
  0042a634: jalr   $s4, $ra           
  0042a638: dsubu  $zero, $s1, +0     
  0042a63c: or     $v0, $s3, +0       
  0042a640: addiu  $s0, $s0, -1       
  0042a644: regimm $s0, $at, -32         ; br -> 0x0046a628
  0042a648: addiu  $s1, $s1, +88      
  0042a64c: lw     $s2, +0($s2)       
  0042a650: bnel   $s2, $zero, -60       ; br -> 0x0046a618
  0042a654: lw     $s0, +4($s2)       
  0042a658: dsubu  $zero, $s3, +0     
