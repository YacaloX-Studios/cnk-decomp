...
; 90 words
  ...
  004299a4: sq     $s1, +16($sp)      
  004299a8: sq     $ra, +48($sp)      
  004299ac: daddu $s1, $a0, $zero     
  004299b0: sq     $s2, +32($sp)      
  ...
  00429ad4: sh     $a1, +12($a0)      
  00429ad8: sh     $a2, +14($a0)      
