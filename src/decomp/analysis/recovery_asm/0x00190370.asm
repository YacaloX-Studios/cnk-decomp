...
; 84 words
  ...
  001903c4: lq     $a1, +0($a1)       
  001903c8: sq     $a1, +0($v1)          ; GLOBAL 0x3f800000
  001903cc: addiu  $a1, $sp, +176     
  001903d0: lq     $v1, +0($v1)          ; GLOBAL 0x3f800000
  001903d4: sq     $v1, +0($a1)       
  001903d8: addiu  $v1, $a0, +16      
  001903dc: lq     $a1, +0($a1)       
  001903e0: sq     $a1, +0($v1)          ; GLOBAL 0x3f800000
  ...
  00190428: lq     $a1, +0($a1)       
  0019042c: sq     $a1, +0($v1)          ; GLOBAL 0x3f800000
  00190430: addiu  $a1, $sp, +128     
  00190434: lq     $v1, +0($v1)          ; GLOBAL 0x3f800000
  00190438: sq     $v1, +0($a1)       
  0019043c: addiu  $v1, $a0, +32      
  00190440: lq     $a1, +0($a1)       
  00190444: sq     $a1, +0($v1)          ; GLOBAL 0x3f800000
  ...
  0019048c: lq     $a1, +0($a1)       
  00190490: sq     $a1, +0($v1)          ; GLOBAL 0x3f800000
  00190494: addiu  $a1, $sp, +80      
  00190498: lq     $v1, +0($v1)          ; GLOBAL 0x3f800000
  0019049c: sq     $v1, +0($a1)       
  001904a0: addiu  $v1, $a0, +48      
  001904a4: lq     $a0, +0($a1)       
  001904a8: sq     $a0, +0($v1)          ; GLOBAL 0x3f800000
  001904ac: jr     $ra                
