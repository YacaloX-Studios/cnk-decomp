...
; 100 words
  ...
  0026d988: and    $a3, $t1, +0       
  0026d98c: and    $v1, $t1, +0       
  0026d990: srl    $a3, $zero, +24    
  0026d994: srl    $v1, $zero, +8     
  0026d998: addu   $v1, $a3, +0       
  0026d99c: andi   $v1, $t1, -256     
  0026d9a0: sll    $v1, $zero, +8     
  0026d9a4: andi   $v1, $t1, +255     
  0026d9a8: addu   $t0, $a3, +0       
  0026d9ac: sll    $v1, $zero, +24    
  0026d9b0: addu   $a3, $v1, +0       
  ...
  0026d9e8: and    $v0, $t4, +0       
  0026d9ec: and    $t3, $t4, +0       
  0026d9f0: srl    $t1, $zero, +24    
  0026d9f4: srl    $t0, $zero, +8     
  0026d9f8: addu   $t0, $t1, +0       
  0026d9fc: andi   $t0, $t4, -256     
  0026da00: sll    $t0, $zero, +8     
  0026da04: andi   $t0, $t4, +255     
  0026da08: addu   $t2, $t1, +0       
  0026da0c: sll    $t0, $zero, +24    
  0026da10: addu   $t1, $t0, +0       
  0026da14: mult   $t0, $a1, +0       
  0026da18: addu   $a1, $a2, +0       
  0026da1c: sll    $a1, $zero, +2     
  0026da20: addu   $a1, $v1, +0       
  0026da24: lwc1   $zero, +0($v1)        ; GLOBAL 0x00ff0000
  0026da28: swc1   $zero, +4($sp)     
  0026da2c: lw     $a2, +0($a3)          ; GLOBAL 0xff000000
  0026da30: and    $v0, $a2, +0       
  0026da34: and    $t3, $a2, +0       
  0026da38: srl    $v1, $zero, +24    
  0026da3c: srl    $v0, $zero, +8     
  0026da40: addu   $v0, $v1, +0       
  0026da44: andi   $v0, $a2, -256     
  0026da48: sll    $v0, $zero, +8     
  0026da4c: andi   $v0, $a2, +255     
  0026da50: addu   $a1, $v1, +0       
  0026da54: sll    $v0, $zero, +24    
  0026da58: addu   $v1, $v0, +0       
