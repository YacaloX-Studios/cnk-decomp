...
; 340 words
  ...
  0010cd0c: sll $a1, $a1, 2           
  0010cd10: sw     $a2, +8($a0)       
  0010cd14: addu $a0, $a1, $a0        
  0010cd18: lw     $a1, +12($a0)      
  0010cd1c: srl $a0, $a1, 11          
  0010cd20: xor $a1, $a1, $a0         
  0010cd24: sll $a0, $a1, 7           
  0010cd28: spec3c  $zero,$a0,$a0     
  0010cd2c: spec3e  $zero,$a0,$a0     
  0010cd30: and $v1, $a0, $v1         
  0010cd34: spec3c  $zero,$v1,$v1     
  0010cd38: spec3f  $zero,$v1,$v1     
  0010cd3c: xor $a0, $a1, $v1         
  0010cd40: sll $v1, $a0, 15          
  0010cd44: spec3c  $zero,$v1,$v1     
  0010cd48: spec3e  $zero,$v1,$v1     
  0010cd4c: and $v0, $v1, $v0         
  0010cd50: spec3c  $zero,$v0,$v0     
  0010cd54: spec3f  $zero,$v0,$v0     
  0010cd58: xor $v1, $a0, $v0         
  0010cd5c: srl $v0, $v1, 18          
  0010cd60: xor $v0, $v1, $v0         
  0010cd64: srl $v0, $v0, 1           
  0010cd68: jr     $ra                
