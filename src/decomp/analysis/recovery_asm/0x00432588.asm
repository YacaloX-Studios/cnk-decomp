...
; 134 words
  ...
  00432594: dsubu $s1, $a0, $zero     
  00432598: sw     $s2, +32($sp)      
  0043259c: sw     $s0, +0($sp)       
  004325a0: dsubu $v0, $s1, $zero     
  ...
  004325b8: dadd $v0, $v0, $s0        
  004325bc: bne    $v0, $zero, +80       ; br -> 0x00432610
  004325c0: dsubu $s2, $zero, $zero   
  ...
  00432698: dsubu $s1, $v0, $zero     
  0043269c: jal   0xf03fb210             ; -> 0x003fb210
  004326a0: dsubu $a0, $s2, $zero     
  ...
  004326c0: dsubu $s0, $v0, $zero     
  004326c4: jal   0xf03fb210             ; -> 0x003fb210
  004326c8: dsubu $a0, $s1, $zero     
  004326cc: dsubu $a0, $s0, $zero     
  004326d0: jal   0xf03fb150             ; -> 0x003fb150
  004326d4: dsubu $a1, $v0, $zero     
  ...
  004326f0: dsubu $s0, $v0, $zero     
  004326f4: jal   0xf03fb210             ; -> 0x003fb210
  004326f8: dsubu $a0, $s2, $zero     
  004326fc: dsubu $a0, $s0, $zero     
  00432700: beq    $zero, $zero, +12     ; br -> 0x00432710
  00432704: dsubu $a1, $v0, $zero     
  00432708: dsubu $a1, $a0, $zero     
