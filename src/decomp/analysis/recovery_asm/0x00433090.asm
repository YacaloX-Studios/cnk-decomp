...
; 842 words
  ...
  00433094: sq     $s7, +592($sp)     
  00433098: sq     $s2, +512($sp)     
  0043309c: daddu $s7, $a2, $zero     
  004330a0: sq     $s1, +496($sp)     
  004330a4: daddu $s2, $a3, $zero     
  004330a8: sq     $ra, +624($sp)     
  004330ac: daddu $s1, $a1, $zero     
  004330b0: sq     $fp, +608($sp)     
  004330b4: sq     $s6, +576($sp)     
  004330b8: sq     $s5, +560($sp)     
  004330bc: sq     $s4, +544($sp)     
  004330c0: sq     $s3, +528($sp)     
  004330c4: jal   0xf0428630             ; -> FUN_00428630
  004330c8: sq     $s0, +480($sp)     
  ...
  00433168: lh     $a0, +14($s1)      
  0043316c: addiu  $v0, $zero, +1     
  00433170: sh     $v0, +14($s1)      
  00433174: lh     $a0, +14($s1)      
  00433178: daddu $a1, $s4, $zero     
  0043317c: daddu $a2, $s3, $zero     
  00433180: jal   0xf0432eb8             ; -> 0x00432eb8
  00433184: daddu $a3, $zero, $zero   
  ...
  0043319c: sb     $zero, +384($sp)   
  004331a0: sw     $zero, +404($sp)   
  004331a4: daddu $s3, $zero, $zero   
  ...
  00433380: dsubu $s0, $zero, $s0     
  00433384: beq    $zero, $zero, +760    ; br -> 0x00433680
  00433388: sb     $v0, +384($sp)     
  ...
  004334ac: sd     $v1, +0($v0)          ; GLOBAL 0x006a0000
  ...
  004334c8: sd     $a0, +0($v0)          ; GLOBAL 0x006a0000
  ...
  004334e4: sh     $a1, +0($v0)          ; GLOBAL 0x006a0000
  ...
  004335b8: daddu $a0, $s4, $zero     
  004335bc: sw     $v0, +408($sp)     
  004335c0: andi   $a0, $s3, +4       
  004335c4: sb     $zero, +384($sp)   
  ...
  0043367c: sb     $zero, +384($sp)   
  00433680: daddu $a1, $fp, $zero     
  ...
  004337ac: lbu    $v1, +0($v0)          ; GLOBAL 0x006a0000
  ...
  00433934: lh     $a0, +14($s1)      
  00433938: addiu  $v0, $zero, +1     
  0043393c: sh     $v0, +14($s1)      
  00433940: lh     $a0, +14($s1)      
  00433944: addiu  $a1, $t0, +20080   
  00433948: daddu $a2, $s0, $zero     
  0043394c: jal   0xf0432eb8             ; -> 0x00432eb8
  00433950: daddu $a3, $zero, $zero   
  00433954: lb     $v0, +384($sp)     
  00433958: beq    $v0, $zero, +88       ; br -> 0x004339b4
  0043395c: lbu    $a0, +384($sp)     
  00433960: lhu    $v0, +12($s1)      
  ...
  004339c0: lhu    $v1, +12($s1)      
  004339c4: sb     $v0, +368($sp)     
  004339c8: andi   $v1, $v1, +512     
  004339cc: beq    $v1, $zero, +40       ; br -> 0x004339f8
  004339d0: sb     $s6, +369($sp)     
  004339d4: lw     $v1, +0($s1)       
  004339d8: lb     $a0, +368($sp)     
  004339dc: lb     $a1, +369($sp)     
  004339e0: sb     $a0, +0($v1)       
  004339e4: sb     $a1, +1($v1)       
  004339e8: lw     $v0, +0($s1)       
  ...
  00433af4: lh     $a0, +14($s1)      
  00433af8: addiu  $v0, $zero, +1     
  00433afc: sh     $v0, +14($s1)      
  00433b00: lh     $a0, +14($s1)      
  00433b04: addiu  $a1, $s3, +20096   
  00433b08: daddu $a2, $s0, $zero     
  00433b0c: jal   0xf0432eb8             ; -> 0x00432eb8
  00433b10: daddu $a3, $zero, $zero   
  ...
  00433bd4: lh     $a0, +14($s1)      
  00433bd8: addiu  $v0, $zero, +1     
  00433bdc: sh     $v0, +14($s1)      
  00433be0: lh     $a0, +14($s1)      
  00433be4: addiu  $a1, $s3, +20096   
  00433be8: daddu $a2, $s0, $zero     
  00433bec: jal   0xf0432eb8             ; -> 0x00432eb8
  00433bf0: daddu $a3, $zero, $zero   
  00433bf4: lhu    $v0, +12($s1)      
  00433bf8: andi   $v0, $v0, +512     
  00433bfc: beq    $v0, $zero, +36       ; br -> 0x00433c24
  00433c00: daddu $a1, $s4, $zero     
  00433c04: lw     $a0, +0($s1)       
  ...
  00433c2c: lh     $a0, +14($s1)      
  00433c30: addiu  $v0, $zero, +1     
  00433c34: sh     $v0, +14($s1)      
  00433c38: lh     $a0, +14($s1)      
  00433c3c: daddu $a1, $s4, $zero     
  00433c40: lw     $a2, +408($sp)     
  00433c44: jal   0xf0432eb8             ; -> 0x00432eb8
  00433c48: daddu $a3, $zero, $zero   
  ...
  00433d24: lh     $a0, +14($s1)      
  00433d28: addiu  $v0, $zero, +1     
  00433d2c: sh     $v0, +14($s1)      
  00433d30: lh     $a0, +14($s1)      
  00433d34: addiu  $a1, $t0, +20080   
  00433d38: daddu $a2, $s0, $zero     
  00433d3c: jal   0xf0432eb8             ; -> 0x00432eb8
  00433d40: daddu $a3, $zero, $zero   
  ...
  00433d60: lhu    $v0, +12($s1)      
  00433d64: andi   $v0, $v0, +512     
  00433d68: bne    $v0, $zero, +28       ; br -> 0x00433d88
  00433d6c: lw     $v0, +396($sp)     
  00433d70: lh     $a0, +14($s1)      
  00433d74: daddu $a1, $zero, $zero   
  00433d78: daddu $a2, $zero, $zero   
  00433d7c: jal   0xf0432eb8             ; -> 0x00432eb8
  00433d80: addiu  $a3, $zero, +1     
  00433d84: lw     $v0, +396($sp)     
  00433d88: lq     $ra, +624($sp)     
  00433d8c: lq     $fp, +608($sp)     
  00433d90: lq     $s7, +592($sp)     
  00433d94: lq     $s6, +576($sp)     
  00433d98: lq     $s5, +560($sp)     
  00433d9c: lq     $s4, +544($sp)     
  00433da0: lq     $s3, +528($sp)     
  00433da4: lq     $s2, +512($sp)     
  00433da8: lq     $s1, +496($sp)     
  00433dac: lq     $s0, +480($sp)     
  00433db0: jr     $ra                
