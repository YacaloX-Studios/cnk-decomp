...
; 842 words
  ...
  0043309c: dsubu  $zero, $a2, +0     
  004330a0: sw     $s1, +496($sp)     
  004330a4: dsubu  $zero, $a3, +0     
  004330a8: sw     $ra, +624($sp)     
  004330ac: dsubu  $zero, $a1, +0     
  ...
  00433140: dsubu  $zero, $s4, +0     
  00433144: lw     $a0, +0($s1)       
  00433148: jal   0xf04287e0             ; -> 0x004287e0
  0043314c: dsubu  $zero, $s3, +0     
  00433150: lw     $v1, +0($s1)       
  00433154: addu   $s3, $v1, +0       
  ...
  00433178: dsubu  $zero, $s4, +0     
  0043317c: dsubu  $zero, $s3, +0     
  00433180: jal   0xf0432eb8             ; -> 0x00432eb8
  00433184: dsubu  $zero, $zero, +0   
  00433188: lw     $v0, +396($sp)     
  0043318c: addu   $s3, $v0, +0       
  ...
  004331c8: sll    $v1, $zero, +2     
  004331cc: addiu  $v0, $v0, +20208   
  004331d0: addu   $v0, $v1, +0       
  004331d4: lw     $a0, +0($v1)       
  004331d8: jr     $a0                
  004331dc: sll    $zero, $zero, +0   
  004331e0: lw     $v0, +384($sp)     
  004331e4: bnel   $v0, $zero, -52       ; br -> 0x004731b4
  004331e8: lw     $s6, +0($s7)       
  004331ec: addiu  $v0, $zero, +32    
  004331f0: beq    $zero, $zero, -68     ; br -> 0x004731b0
  004331f4: sw     $v0, +384($sp)     
  004331f8: beq    $zero, $zero, -76     ; br -> 0x004731b0
  004331fc: ori    $s3, $s3, +1       
  00433200: addiu  $s2, $s2, +8       
  00433204: lw     $v1, -8($s2)       
  00433208: regimm $v1, $at, -92         ; br -> 0x004731b0
  0043320c: sw     $v1, +400($sp)     
  00433210: subu   $v1, $zero, +0     
  00433214: sw     $v1, +400($sp)     
  00433218: beq    $zero, $zero, -108    ; br -> 0x004731b0
  0043321c: ori    $s3, $s3, +4       
  00433220: addiu  $v0, $zero, +43    
  00433224: beq    $zero, $zero, -120    ; br -> 0x004731b0
  ...
  004334c0: lw     $v0, -8($s2)       
  004334c4: beq    $zero, $zero, -992    ; br -> 0x004730e8
  ...
  004334dc: lw     $v0, -8($s2)       
  004334e0: beq    $zero, $zero, -1020   ; br -> 0x004730e8
  004334e4: sw     $a1, +0($v0)          ; GLOBAL 0x006a0000
  004334e8: addiu  $s2, $s2, +8       
  004334ec: lw     $a2, +396($sp)     
  004334f0: lw     $v0, -8($s2)       
  004334f4: beq    $zero, $zero, -1040   ; br -> 0x004730e8
  ...
  0043357c: dsubu  $zero, $s4, +0     
  00433580: dsubu  $zero, $zero, +0   
  00433584: jal   0xf0428658             ; -> 0x00428658
  00433588: dsubu  $zero, $fp, +0     
  0043358c: beq    $v0, $zero, +28       ; br -> 0x004335ac
  00433590: subu   $s4, $v0, +0       
  00433594: sw     $v0, +408($sp)     
  00433598: dadd   $v0, $fp, +0       
  0043359c: lw     $v1, +408($sp)     
  004335a0: movn    $fp,$v0,$v1       
  ...
  00433748: dsubu  $zero, $s0, +0     
  0043374c: andi   $v0, $v0, +255     
  00433750: addiu  $a1, $zero, +10    
  00433754: jal   0xf03f8938             ; -> 0x003f8938
  00433758: sw     $v0, +0($s4)       
  0043375c: dsubu  $zero, $v0, +0     
  00433760: sltiu  $v0, $s0, +10      
  00433764: beq    $v0, $zero, -48       ; br -> 0x00473738
  00433768: dsubu  $zero, $s0, +0     
  ...
  00433918: dsubu  $zero, $s0, +0     
  0043391c: lw     $v1, +0($s1)       
  00433920: addu   $s0, $v1, +0       
  ...
  00433948: dsubu  $zero, $s0, +0     
  0043394c: jal   0xf0432eb8             ; -> 0x00432eb8
  00433950: dsubu  $zero, $zero, +0   
  ...
  00433aac: dsubu  $zero, $zero, +0   
  00433ab0: addiu  $s0, $s0, -16      
  00433ab4: slti   $v0, $s0, +17      
  00433ab8: beql   $v0, $zero, -108      ; br -> 0x00473a50
  ...
  00433ad8: dsubu  $zero, $s0, +0     
  00433adc: lw     $v1, +0($s1)       
  00433ae0: addu   $s0, $v1, +0       
  ...
  00433b08: dsubu  $zero, $s0, +0     
  00433b0c: jal   0xf0432eb8             ; -> 0x00432eb8
  00433b10: dsubu  $zero, $zero, +0   
  ...
  00433b8c: dsubu  $zero, $zero, +0   
  00433b90: addiu  $s0, $s0, -16      
  00433b94: slti   $v0, $s0, +17      
  00433b98: beql   $v0, $zero, -108      ; br -> 0x00473b30
  ...
  00433bb8: dsubu  $zero, $s0, +0     
  00433bbc: lw     $v1, +0($s1)       
  00433bc0: addu   $s0, $v1, +0       
  ...
  00433d08: dsubu  $zero, $s0, +0     
  00433d0c: lw     $v1, +0($s1)       
  00433d10: addu   $s0, $v1, +0       
  ...
  00433d38: dsubu  $zero, $s0, +0     
  00433d3c: jal   0xf0432eb8             ; -> 0x00432eb8
  00433d40: dsubu  $zero, $zero, +0   
  00433d44: lw     $v0, +400($sp)     
  00433d48: lw     $v1, +420($sp)     
  00433d4c: lw     $a0, +396($sp)     
  00433d50: movz    $fp,$v1,$v0       
  00433d54: addu   $v0, $a0, +0       
  00433d58: beq    $zero, $zero, -3188   ; br -> 0x004730e8
  ...
  00433d74: dsubu  $zero, $zero, +0   
  00433d78: dsubu  $zero, $zero, +0   
