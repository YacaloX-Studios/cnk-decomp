...
; 66 words
  ...
  0042c744: dsubu $t0, $a2, $zero     
  0042c748: sw     $s4, +64($sp)      
  0042c74c: dsubu $t1, $zero, $zero   
  0042c750: sw     $s3, +48($sp)      
  0042c754: dsubu $s4, $a0, $zero     
  0042c758: sw     $s1, +16($sp)      
  0042c75c: dsubu $s3, $a3, $zero     
  0042c760: sw     $ra, +80($sp)      
  0042c764: dsubu $s1, $a1, $zero     
  0042c768: sw     $s0, +0($sp)       
