...
; 56 words
  ...
  00154dd0: bne    $v0, $zero, -92       ; br -> 0x00194d78
  00154dd4: addiu  $a0, $a0, +20      
  00154dd8: jr     $ra                
  00154ddc: addiu  $sp, $sp, +16      
  00154de0: sll    $a1, $zero, +2     
  00154de4: addu   $a1, $v0, +0       
  00154de8: sll    $v0, $zero, +2     
  00154dec: addu   $a0, $v0, +0       
  00154df0: jr     $ra                
  00154df4: lw     $v0, +40($v0)         ; GLOBAL 0x7f7f0028
  00154df8: sll    $zero, $zero, +0   
  00154dfc: sll    $zero, $zero, +0   
  00154e00: sll    $a1, $zero, +2     
  00154e04: addu   $a1, $v0, +0       
  00154e08: sll    $v0, $zero, +2     
  00154e0c: addu   $a0, $v0, +0       
  00154e10: jr     $ra                
