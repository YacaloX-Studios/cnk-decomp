...
; 314 words
  ...
  004286e0: or $v0, $v0, $v1          
  004286e4: bnel   $v0, $zero, +24       ; br -> 0x00428700
  004286e8: daddu $a0, $a3, $zero     
  004286ec: addiu  $a2, $a2, -16      
  004286f0: sltiu  $v0, $a2, +16      
  004286f4: beq    $v0, $zero, -56       ; br -> 0x004286c0
  004286f8: addiu  $a3, $a3, +16      
  004286fc: daddu $a0, $a3, $zero     
  ...
  0042877c: or $t1, $t2, $t0          
  00428780: movz   $a1, $v0, $t1      
  00428784: bnel   $t1, $zero, +12       ; br -> 0x00428794
  00428788: addiu  $a0, $a0, -16      
  0042878c: beq    $a3, $zero, -48       ; br -> 0x00428760
  ...
  00428a0c: beql   $v0, $zero, -24       ; br -> 0x004289f8
  00428a10: sd     $v1, +0($a3)          ; GLOBAL 0xffff0000
  00428a14: daddu $v1, $a3, $zero     
  ...
  00428a34: sb     $a1, +0($v1)          ; GLOBAL 0xffff0000
  00428a38: addiu  $a2, $a2, -1       
  00428a3c: sll $zero, $zero, 0       
  00428a40: sll $zero, $zero, 0       
  00428a44: sll $zero, $zero, 0       
  00428a48: bne    $a2, $v0, -24         ; br -> 0x00428a34
  00428a4c: addiu  $v1, $v1, +1       
  00428a50: jr     $ra                
  00428a54: daddu $v0, $a0, $zero     
  00428a58: sq     $s0, +0($a0)       
  00428a5c: sq     $s1, +16($a0)      
  00428a60: sq     $s2, +32($a0)      
  00428a64: sq     $s3, +48($a0)      
  00428a68: sq     $s4, +64($a0)      
  00428a6c: sq     $s5, +80($a0)      
  00428a70: sq     $s6, +96($a0)      
  00428a74: sq     $s7, +112($a0)     
  00428a78: sq     $fp, +128($a0)     
  ...
  00428a9c: sq     $sp, +176($a0)     
  00428aa0: sq     $ra, +192($a0)     
  00428aa4: daddu $v0, $zero, $zero   
  00428aa8: jr     $ra                
  00428aac: sll $zero, $zero, 0       
  00428ab0: lq     $s0, +0($a0)       
  00428ab4: lq     $s1, +16($a0)      
  00428ab8: lq     $s2, +32($a0)      
  00428abc: lq     $s3, +48($a0)      
  00428ac0: lq     $s4, +64($a0)      
  00428ac4: lq     $s5, +80($a0)      
  00428ac8: lq     $s6, +96($a0)      
  00428acc: lq     $s7, +112($a0)     
  00428ad0: lq     $fp, +128($a0)     
