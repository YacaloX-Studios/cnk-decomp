...
; 314 words
  ...
  00428738: jr     $ra                
  0042873c: dsubu $v0, $zero, $zero   
  00428740: jr     $ra                
  00428744: dsubu $v0, $a0, $zero     
  ...
  00428888: jr     $ra                
  0042888c: dsubu $v0, $t0, $zero     
  00428890: dsubu $t0, $a0, $zero     
  00428894: daddu $v0, $a1, $t0       
  00428898: beq    $v0, $zero, +76       ; br -> 0x004288e8
  0042889c: dsubu $v1, $t0, $zero     
  004288a0: addu $a3, $a1, $a2        
  004288a4: daddu $v0, $t0, $a3       
  ...
  004288bc: dsubu $a1, $a3, $zero     
  004288c0: dsubu $a0, $v0, $zero     
