...
; 44 words
  ...
  00431224: sll $v0, $a2, 3           
  00431228: addu $a1, $v0, $t2        
  ...
  0043124c: and $v0, $v0, $a0         
  00431250: sll $zero, $zero, 0       
  00431254: bne    $v1, $a1, -24         ; br -> 0x00431240
  00431258: addu $a3, $a3, $v0        
  0043125c: slti   $v0, $a2, +128     
  00431260: bne    $v0, $zero, -60       ; br -> 0x00431228
  00431264: sll $v0, $a2, 3           
  00431268: lw     $v0, +32512($t1)      ; GLOBAL 0x00657f00
  0043126c: addiu  $v1, $t3, +31440   
  00431270: lw     $a1, +8($v1)       
  00431274: addiu  $a0, $t1, +32512   
  00431278: subu $v0, $v0, $a3        
