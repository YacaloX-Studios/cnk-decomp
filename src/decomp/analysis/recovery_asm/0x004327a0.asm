...
; 30 words
  ...
  004327a0: daddu $t1, $a0, $zero     
  004327a4: lb     $v0, +0($t1)       
  004327a8: beq    $v0, $zero, +40       ; br -> 0x004327d4
  004327ac: daddu $a3, $zero, $zero   
