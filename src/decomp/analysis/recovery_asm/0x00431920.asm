...
; 126 words
  ...
  00431924: daddu $a1, $a0, $zero     
  00431928: sq     $ra, +80($sp)      
  0043192c: sq     $s4, +64($sp)      
  00431930: sq     $s3, +48($sp)      
  00431934: sq     $s2, +32($sp)      
  00431938: sq     $s1, +16($sp)      
  0043193c: sq     $s0, +0($sp)       
  00431940: daddu $v0, $a1, $zero     
  ...
  00431978: ld     $a1, +19736($v0)      ; GLOBAL 0x006a4d18
  0043197c: daddu $a0, $v0, $zero     
  00431980: jal   0xf03fb6f8             ; -> 0x003fb6f8
  00431984: daddu $a1, $zero, $zero   
  ...
  00431998: daddu $s2, $zero, $zero   
  0043199c: beq    $zero, $zero, +288    ; br -> 0x00431ac0
  004319a0: daddu $s0, $zero, $zero   
  ...
  004319dc: daddu $a0, $a1, $zero     
  004319e0: lui   $v0, 0x006a0000     
  004319e4: jal   0xf03fb150             ; -> 0x003fb150
  004319e8: ld     $a1, +19736($v0)      ; GLOBAL 0x006a4d18
  004319ec: daddu $a0, $v0, $zero     
  004319f0: jal   0xf03fb6f8             ; -> 0x003fb6f8
  004319f4: daddu $a1, $zero, $zero   
  ...
  00431a5c: daddu $a0, $a1, $zero     
  00431a60: lui   $v0, 0x006a0000     
  00431a64: jal   0xf03fb150             ; -> 0x003fb150
  00431a68: ld     $a1, +19736($v0)      ; GLOBAL 0x006a4d18
  00431a6c: daddu $a0, $v0, $zero     
  00431a70: jal   0xf03fb6f8             ; -> 0x003fb6f8
  00431a74: daddu $a1, $zero, $zero   
  ...
  00431aac: sltu $v0, $v1, $s2        
  00431ab0: addu $s0, $s0, $v0        
  00431ab4: daddu $s2, $v1, $zero     
  ...
  00431af0: daddu $v0, $a1, $zero     
  00431af4: lq     $ra, +80($sp)      
  00431af8: lq     $s4, +64($sp)      
  00431afc: lq     $s3, +48($sp)      
  00431b00: lq     $s2, +32($sp)      
  00431b04: lq     $s1, +16($sp)      
  00431b08: lq     $s0, +0($sp)       
  00431b0c: jr     $ra                
