...
; 312 words
  ...
  0042f178: dsubu  $zero, $a2, +0     
  0042f17c: sw     $ra, +160($sp)     
  0042f180: dsubu  $zero, $a3, +0     
  ...
  0042f1a8: lw     $s1, +0($s2)       
  0042f1ac: addu   $a1, $s1, +0       
  0042f1b0: lw     $v0, +0($v1)       
  0042f1b4: andi   $v0, $v0, +8       
  0042f1b8: sll    $zero, $zero, +0   
  0042f1bc: bne    $v0, $zero, -24       ; br -> 0x0046f1a8
  ...
  0042f2f4: beq    $zero, $zero, -128    ; br -> 0x0046f278
  0042f2f8: movz    $v1,$v0,$s1       
  ...
  0042f3c0: sll    $a2, $zero, +24    
  0042f3c4: lw     $t0, +0($t2)       
  0042f3c8: sra    $a2, $zero, +24    
  0042f3cc: addu   $t3, $a2, +0       
  0042f3d0: addu   $t3, $t0, +0       
  ...
  0042f484: lw     $v0, +0($a1)       
  0042f488: bnel   $v0, $zero, -36       ; br -> 0x0046f468
  0042f48c: lw     $a2, +0($a1)       
  0042f490: jr     $ra                
  0042f494: dsubu  $zero, $a0, +0     
  0042f498: dsubu  $zero, $a0, +0     
  0042f49c: dsubu  $zero, $a2, +0     
  0042f4a0: bne    $t1, $zero, +12       ; br -> 0x0042f4b0
  0042f4a4: dsubu  $zero, $a1, +0     
  0042f4a8: jr     $ra                
  0042f4ac: dsubu  $zero, $zero, +0   
  ...
  0042f524: bne    $t1, $t4, -88         ; br -> 0x0046f4d0
  0042f528: addiu  $t3, $t3, +1       
  0042f52c: lw     $a3, +0($t2)       
  0042f530: addiu  $v0, $t6, +17361   
  0042f534: lw     $a2, +0($t3)       
  0042f538: addu   $v0, $a3, +0       
  0042f53c: addiu  $a1, $a3, +32      
  0042f540: addu   $v0, $a2, +0       
  0042f544: lw     $v1, +0($t0)       
  0042f548: lw     $a0, +0($v0)          ; GLOBAL 0xffff0000
  0042f54c: addiu  $v0, $a2, +32      
  0042f550: andi   $v1, $v1, +1       
  0042f554: andi   $a0, $a0, +1       
  0042f558: movz    $a3,$v1,$a1       
  0042f55c: movz    $a2,$a0,$v0       
  0042f560: jr     $ra                
  0042f564: subu   $v0, $a1, +0       
  0042f568: sll    $a1, $zero, +24    
  0042f56c: lw     $v0, +0($a0)       
  0042f570: sra    $a1, $zero, +24    
  0042f574: dsubu  $zero, $zero, +0   
  0042f578: beq    $v0, $zero, +36       ; br -> 0x0042f5a0
  0042f57c: lw     $v1, +0($a0)       
  0042f580: sll    $v1, $zero, +24    
  0042f584: sra    $v0, $zero, +24    
  0042f588: xor    $a1, $v0, +0       
  0042f58c: movz    $a0,$v0,$a2       
  0042f590: addiu  $a0, $a0, +1       
  0042f594: lw     $v0, +0($a0)       
  0042f598: bne    $v0, $zero, -28       ; br -> 0x0046f580
  0042f59c: lw     $v1, +0($a0)       
  0042f5a0: lw     $v1, +0($a0)       
  0042f5a4: dsubu  $zero, $a0, +0     
  0042f5a8: xor    $a1, $v1, +0       
  0042f5ac: jr     $ra                
  0042f5b0: movn    $a2,$v1,$v0       
  0042f5b4: sll    $zero, $zero, +0   
  0042f5b8: lw     $v0, +0($a0)       
  0042f5bc: bne    $v0, $zero, +24       ; br -> 0x0042f5d8
  0042f5c0: lw     $v1, +0($a1)       
  0042f5c4: dsubu  $zero, $zero, +0   
  0042f5c8: jr     $ra                
  0042f5cc: movz    $a0,$v1,$v0       
  0042f5d0: jr     $ra                
  0042f5d4: dsubu  $zero, $a0, +0     
  0042f5d8: sll    $zero, $zero, +0   
  0042f5dc: sll    $zero, $zero, +0   
  0042f5e0: sll    $zero, $zero, +0   
  0042f5e4: beq    $v1, $zero, -24       ; br -> 0x0046f5d0
  0042f5e8: dsubu  $zero, $zero, +0   
  0042f5ec: lw     $v0, +0($a0)       
  0042f5f0: bnel   $v1, $v0, +44         ; br -> 0x0042f620
  0042f5f4: addiu  $a0, $a0, +1       
  0042f5f8: addiu  $a3, $a3, +1       
  0042f5fc: sll    $zero, $zero, +0   
  0042f600: addu   $a3, $a1, +0       
  0042f604: lw     $a2, +0($v0)          ; GLOBAL 0xffff0000
  0042f608: beq    $a2, $zero, -60       ; br -> 0x0046f5d0
  0042f60c: addu   $a3, $a0, +0       
  0042f610: lw     $v1, +0($v0)          ; GLOBAL 0xffff0000
  0042f614: beql   $a2, $v1, -24         ; br -> 0x0046f600
  0042f618: addiu  $a3, $a3, +1       
  0042f61c: addiu  $a0, $a0, +1       
  0042f620: lw     $v0, +0($a0)       
  0042f624: bnel   $v0, $zero, -80       ; br -> 0x0046f5d8
  0042f628: lw     $v1, +0($a1)       
  0042f62c: jr     $ra                
  0042f630: dsubu  $zero, $zero, +0   
