...
; 192 words
  ...
  00115494: dsubu  $zero, $zero, +0   
  00115498: ori    $at, $at, +6468    
  0011549c: addu   $at, $a0, +0       
  ...
  00115514: dsubu  $zero, $zero, +0   
  00115518: ori    $at, $at, +6468    
  0011551c: addu   $at, $a0, +0       
  ...
  00115578: addu   $v1, $a0, +0       
  0011557c: dsubu  $zero, $t3, +0     
  00115580: lw     $t7, +6468($v1)       ; GLOBAL 0x00011944
  00115584: lui   $a1, 0xff000000     
  00115588: lui   $t1, 0x00010000     
  0011558c: lui   $a3, 0x00010000     
  00115590: dsubu  $zero, $t1, +0     
  00115594: addu   $t3, $a0, +0       
  00115598: addu   $t2, $a0, +0       
  0011559c: addu   $t1, $a0, +0       
  001155a0: addu   $t0, $a0, +0       
  001155a4: addu   $a3, $a0, +0       
  001155a8: dsubu  $zero, $zero, +0   
  001155ac: lui   $v1, 0x00ff0000     
  001155b0: and    $a1, $t7, +0       
  001155b4: and    $v1, $t7, +0       
  001155b8: srl    $t5, $zero, +24    
  001155bc: srl    $t4, $zero, +8     
  001155c0: addu   $t4, $t5, +0       
  001155c4: andi   $t4, $t7, -256     
  001155c8: sll    $t4, $zero, +8     
  001155cc: andi   $t4, $t7, +255     
  001155d0: addu   $t6, $t5, +0       
  001155d4: sll    $t4, $zero, +24    
  001155d8: addu   $t5, $t4, +0       
  001155dc: sw     $t4, +6468($t3)       ; GLOBAL 0x00011944
  001155e0: lw     $t5, +6472($t2)    
  001155e4: and    $a1, $t5, +0       
  001155e8: and    $v1, $t5, +0       
  001155ec: srl    $t3, $zero, +24    
  001155f0: srl    $t2, $zero, +8     
  001155f4: addu   $t2, $t3, +0       
  001155f8: andi   $t2, $t5, -256     
  001155fc: sll    $t2, $zero, +8     
  00115600: andi   $t2, $t5, +255     
  00115604: addu   $t4, $t3, +0       
  00115608: sll    $t2, $zero, +24    
  0011560c: addu   $t3, $t2, +0       
  00115610: sw     $t2, +6472($t1)       ; GLOBAL 0x00011948
  00115614: lw     $t3, +6476($t0)    
  00115618: and    $a1, $t3, +0       
  0011561c: and    $v1, $t3, +0       
  00115620: srl    $t1, $zero, +24    
  00115624: srl    $t0, $zero, +8     
  00115628: addu   $t0, $t1, +0       
  0011562c: andi   $t0, $t3, -256     
  00115630: sll    $t0, $zero, +8     
  00115634: andi   $t0, $t3, +255     
  00115638: addu   $t2, $t1, +0       
  0011563c: sll    $t0, $zero, +24    
  00115640: addu   $t1, $t0, +0       
  ...
  00115654: and    $a1, $t3, +0       
  00115658: and    $v1, $t3, +0       
  0011565c: srl    $t1, $zero, +24    
  00115660: srl    $t0, $zero, +8     
  00115664: addu   $t0, $t1, +0       
  00115668: andi   $t0, $t3, -256     
  0011566c: sll    $t0, $zero, +8     
  00115670: andi   $t0, $t3, +255     
  00115674: addu   $t2, $t1, +0       
  00115678: sll    $t0, $zero, +24    
  0011567c: addu   $t1, $t0, +0       
  00115680: sw     $t0, +4($a0)          ; GLOBAL 0x00010004
  00115684: lw     $t3, +8($a0)          ; GLOBAL 0x00010008
  00115688: and    $a1, $t3, +0       
  0011568c: and    $v1, $t3, +0       
  00115690: srl    $t1, $zero, +24    
  00115694: srl    $t0, $zero, +8     
  00115698: addu   $t0, $t1, +0       
  0011569c: andi   $t0, $t3, -256     
  001156a0: sll    $t0, $zero, +8     
  001156a4: andi   $t0, $t3, +255     
  001156a8: addu   $t2, $t1, +0       
  001156ac: sll    $t0, $zero, +24    
  001156b0: addu   $t1, $t0, +0       
  001156b4: sw     $t0, +8($a0)          ; GLOBAL 0x00010008
  001156b8: lw     $t3, +12($a0)         ; GLOBAL 0x0001000c
  001156bc: and    $a1, $t3, +0       
  001156c0: and    $v1, $t3, +0       
  001156c4: srl    $t1, $zero, +24    
  001156c8: srl    $t0, $zero, +8     
  001156cc: addu   $t0, $t1, +0       
  001156d0: andi   $t0, $t3, -256     
  001156d4: sll    $t0, $zero, +8     
  001156d8: andi   $t0, $t3, +255     
  001156dc: addu   $t2, $t1, +0       
  001156e0: sll    $t0, $zero, +24    
  001156e4: addu   $t1, $t0, +0       
  001156e8: sw     $t0, +12($a0)         ; GLOBAL 0x0001000c
  001156ec: bne    $a3, $zero, -168      ; br -> 0x00155648
  ...
  0011570c: and    $v1, $a1, +0       
  00115710: and    $v0, $a1, +0       
  00115714: srl    $v1, $zero, +24    
  00115718: srl    $v0, $zero, +8     
  0011571c: addu   $v0, $v1, +0       
  00115720: andi   $v0, $a1, -256     
  00115724: sll    $v0, $zero, +8     
  00115728: andi   $v0, $a1, +255     
  0011572c: addu   $a0, $v1, +0       
  00115730: sll    $v0, $zero, +24    
  00115734: jr     $ra                
  00115738: addu   $v1, $v0, +0       
  0011573c: sll    $zero, $zero, +0   
  00115740: sw     $a1, +0($a0)          ; GLOBAL 0x00010000
  00115744: dsubu  $zero, $a0, +0     
