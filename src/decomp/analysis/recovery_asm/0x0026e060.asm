...
; 80 words
  ...
  0026e084: lw     $t1, +0($t0)       
  0026e088: and    $a3, $t1, +0       
  0026e08c: and    $a0, $t1, +0       
  0026e090: srl    $a3, $zero, +24    
  0026e094: srl    $a0, $zero, +8     
  0026e098: addu   $a0, $a3, +0       
  0026e09c: andi   $a0, $t1, -256     
  0026e0a0: sll    $a0, $zero, +8     
  0026e0a4: andi   $a0, $t1, +255     
  0026e0a8: addu   $t0, $a3, +0       
  0026e0ac: sll    $a0, $zero, +24    
  0026e0b0: addu   $a3, $a0, +0       
  ...
  0026e0c4: dsubu  $zero, $zero, +0   
  0026e0c8: lw     $a0, +12($v1)      
  0026e0cc: lui   $v0, 0xff000000     
  0026e0d0: lui   $t1, 0x00ff0000     
  0026e0d4: lw     $t2, +8($a0)          ; GLOBAL 0x00ff0008
  0026e0d8: and    $v0, $t2, +0       
  0026e0dc: and    $t1, $t2, +0       
  0026e0e0: srl    $a3, $zero, +24    
  0026e0e4: srl    $a0, $zero, +8     
  0026e0e8: addu   $a0, $a3, +0       
  0026e0ec: andi   $a0, $t2, -256     
  0026e0f0: sll    $a0, $zero, +8     
  0026e0f4: andi   $a0, $t2, +255     
  0026e0f8: addu   $t0, $a3, +0       
  0026e0fc: sll    $a0, $zero, +24    
  0026e100: addu   $a3, $a0, +0       
  0026e104: daddu  $a3, $a2, +0       
  ...
  0026e124: addu   $a0, $a2, +0       
  0026e128: addiu  $a3, $sp, +4       
  0026e12c: sll    $a0, $zero, +2     
  0026e130: addu   $a0, $v1, +0       
  0026e134: lwc1   $zero, +0($v1)     
  0026e138: swc1   $zero, +4($sp)     
  0026e13c: lw     $a1, +0($a3)          ; GLOBAL 0xff000000
  0026e140: and    $v0, $a1, +0       
  0026e144: and    $t1, $a1, +0       
  0026e148: srl    $v1, $zero, +24    
  0026e14c: srl    $v0, $zero, +8     
  0026e150: addu   $v0, $v1, +0       
  0026e154: andi   $v0, $a1, -256     
  0026e158: sll    $v0, $zero, +8     
  0026e15c: andi   $v0, $a1, +255     
  0026e160: addu   $a0, $v1, +0       
  0026e164: sll    $v0, $zero, +24    
  0026e168: addu   $v1, $v0, +0       
