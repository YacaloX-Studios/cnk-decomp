...
; 464 words
  ...
  00423d88: sq     $s1, +16($sp)      
  00423d8c: addiu  $v1, $zero, +4     
  00423d90: sq     $s0, +0($sp)       
  00423d94: daddu $t8, $zero, $zero   
  00423d98: lw     $a1, +19184($at)      ; GLOBAL 0x00704af0
  00423d9c: lhu    $a1, +104($a1)     
  ...
  00423e90: lhu    $t3, +60($s1)      
  00423e94: beq    $at, $zero, +1160     ; br -> 0x00424320
  00423e98: daddu $t8, $t5, $zero     
  00423e9c: addu $s0, $s0, $t2        
  00423ea0: lw     $s0, +0($s0)       
  00423ea4: jr     $s0                
  ...
  00423ecc: sra $t3, $t6, 6           
  00423ed0: lhu    $s0, +184($t9)     
  00423ed4: and $s0, $s0, $t1         
  00423ed8: or $s0, $s0, $s1          
  00423edc: regimm $t6, $at, +12         ; br -> 0x00423eec
  00423ee0: sh     $s0, +184($t9)     
  00423ee4: addiu  $t3, $t6, +63      
  00423ee8: sra $t3, $t3, 6           
  ...
  00423f04: ld     $t3, +184($s0)     
  00423f08: and $t3, $t3, $t0         
  00423f0c: or $t3, $t3, $t6          
  00423f10: beq    $zero, $zero, +1036   ; br -> 0x00424320
  00423f14: sd     $t3, +184($s0)     
  00423f18: andi   $s1, $t6, +16383   
  00423f1c: lw     $t9, +19184($at)      ; GLOBAL 0x00704af0
  00423f20: addiu  $t6, $t3, +63      
  00423f24: sra $t3, $t6, 6           
  00423f28: lhu    $s0, +192($t9)     
  00423f2c: and $s0, $s0, $t1         
  00423f30: or $s0, $s0, $s1          
  00423f34: regimm $t6, $at, +12         ; br -> 0x00423f44
  00423f38: sh     $s0, +192($t9)     
  00423f3c: addiu  $t3, $t6, +63      
  00423f40: sra $t3, $t3, 6           
  ...
  00423f5c: ld     $t3, +192($s0)     
  00423f60: and $t3, $t3, $t0         
  00423f64: or $t3, $t3, $t6          
  00423f68: beq    $zero, $zero, +948    ; br -> 0x00424320
  00423f6c: sd     $t3, +192($s0)     
  ...
  00423f9c: sra $t6, $s0, 6           
  00423fa0: ld     $s1, +184($t3)     
  00423fa4: and $s1, $s1, $a3         
  00423fa8: or $s1, $s1, $t9          
  00423fac: regimm $s0, $at, +12         ; br -> 0x00423fbc
  00423fb0: sd     $s1, +184($t3)     
  00423fb4: addiu  $t6, $s0, +63      
  00423fb8: sra $t6, $t6, 6           
  00423fbc: lbu    $s1, +188($t3)     
  00423fc0: andi   $t6, $t6, +63      
  00423fc4: sll $s0, $t6, 2           
  00423fc8: and $t6, $s1, $a2         
  00423fcc: or $t6, $t6, $s0          
  00423fd0: beq    $zero, $zero, +844    ; br -> 0x00424320
  00423fd4: sb     $t6, +188($t3)     
  ...
  00423ff0: sra $t6, $s0, 6           
  00423ff4: ld     $s1, +192($t3)     
  00423ff8: and $s1, $s1, $a3         
  00423ffc: or $s1, $s1, $t9          
  00424000: regimm $s0, $at, +12         ; br -> 0x00424010
  00424004: sd     $s1, +192($t3)     
  00424008: addiu  $t6, $s0, +63      
  0042400c: sra $t6, $t6, 6           
  00424010: lbu    $s1, +196($t3)     
  00424014: andi   $t6, $t6, +63      
  00424018: sll $s0, $t6, 2           
  0042401c: and $t6, $s1, $a2         
  00424020: or $t6, $t6, $s0          
  00424024: beq    $zero, $zero, +760    ; br -> 0x00424320
  00424028: sb     $t6, +196($t3)     
  ...
  00424058: sra $t6, $s0, 6           
  0042405c: ld     $s1, +184($t3)     
  00424060: and $s1, $s1, $a1         
  00424064: or $s1, $s1, $t9          
  00424068: regimm $s0, $at, +12         ; br -> 0x00424078
  0042406c: sd     $s1, +184($t3)     
  00424070: addiu  $t6, $s0, +63      
  00424074: sra $t6, $t6, 6           
  00424078: lhu    $s1, +190($t3)     
  0042407c: andi   $t6, $t6, +63      
  00424080: sll $s0, $t6, 6           
  00424084: and $t6, $s1, $v1         
  00424088: or $t6, $t6, $s0          
  0042408c: beq    $zero, $zero, +656    ; br -> 0x00424320
  00424090: sh     $t6, +190($t3)     
  ...
  004240ac: sra $t6, $s0, 6           
  004240b0: ld     $s1, +192($t3)     
  004240b4: and $s1, $s1, $a1         
  004240b8: or $s1, $s1, $t9          
  004240bc: regimm $s0, $at, +12         ; br -> 0x004240cc
  004240c0: sd     $s1, +192($t3)     
  004240c4: addiu  $t6, $s0, +63      
  004240c8: sra $t6, $t6, 6           
  004240cc: lhu    $s1, +198($t3)     
  004240d0: andi   $t6, $t6, +63      
  004240d4: sll $s0, $t6, 6           
  004240d8: and $t6, $s1, $v1         
  004240dc: or $t6, $t6, $s0          
  004240e0: beq    $zero, $zero, +572    ; br -> 0x00424320
  004240e4: sh     $t6, +198($t3)     
  ...
  00424108: sra $t3, $t6, 6           
  0042410c: lhu    $s0, +200($t9)     
  00424110: and $s0, $s0, $t1         
  00424114: or $s0, $s0, $s1          
  00424118: regimm $t6, $at, +12         ; br -> 0x00424128
  0042411c: sh     $s0, +200($t9)     
  00424120: addiu  $t3, $t6, +63      
  00424124: sra $t3, $t3, 6           
  ...
  00424140: ld     $t3, +200($s0)     
  00424144: and $t3, $t3, $t0         
  00424148: or $t3, $t3, $t6          
  0042414c: beq    $zero, $zero, +464    ; br -> 0x00424320
  00424150: sd     $t3, +200($s0)     
  00424154: andi   $s1, $t6, +16383   
  00424158: lw     $t9, +19184($at)      ; GLOBAL 0x00704af0
  0042415c: addiu  $t6, $t3, +63      
  00424160: sra $t3, $t6, 6           
  00424164: lhu    $s0, +208($t9)     
  00424168: and $s0, $s0, $t1         
  0042416c: or $s0, $s0, $s1          
  00424170: regimm $t6, $at, +12         ; br -> 0x00424180
  00424174: sh     $s0, +208($t9)     
  00424178: addiu  $t3, $t6, +63      
  0042417c: sra $t3, $t3, 6           
  ...
  00424198: ld     $t3, +208($s0)     
  0042419c: and $t3, $t3, $t0         
  004241a0: or $t3, $t3, $t6          
  004241a4: beq    $zero, $zero, +376    ; br -> 0x00424320
  004241a8: sd     $t3, +208($s0)     
  ...
  004241d8: sra $t6, $s0, 6           
  004241dc: ld     $s1, +200($t3)     
  004241e0: and $s1, $s1, $a3         
  004241e4: or $s1, $s1, $t9          
  004241e8: regimm $s0, $at, +12         ; br -> 0x004241f8
  004241ec: sd     $s1, +200($t3)     
  004241f0: addiu  $t6, $s0, +63      
  004241f4: sra $t6, $t6, 6           
  004241f8: lbu    $s1, +204($t3)     
  004241fc: andi   $t6, $t6, +63      
  00424200: sll $s0, $t6, 2           
  00424204: and $t6, $s1, $a2         
  00424208: or $t6, $t6, $s0          
  0042420c: beq    $zero, $zero, +272    ; br -> 0x00424320
  00424210: sb     $t6, +204($t3)     
  ...
  0042422c: sra $t6, $s0, 6           
  00424230: ld     $s1, +208($t3)     
  00424234: and $s1, $s1, $a3         
  00424238: or $s1, $s1, $t9          
  0042423c: regimm $s0, $at, +12         ; br -> 0x0042424c
  00424240: sd     $s1, +208($t3)     
  00424244: addiu  $t6, $s0, +63      
  00424248: sra $t6, $t6, 6           
  0042424c: lbu    $s1, +212($t3)     
  00424250: andi   $t6, $t6, +63      
  00424254: sll $s0, $t6, 2           
  00424258: and $t6, $s1, $a2         
  0042425c: or $t6, $t6, $s0          
  00424260: beq    $zero, $zero, +188    ; br -> 0x00424320
  00424264: sb     $t6, +212($t3)     
  ...
  00424294: sra $t6, $s0, 6           
  00424298: ld     $s1, +200($t3)     
  0042429c: and $s1, $s1, $a1         
  004242a0: or $s1, $s1, $t9          
  004242a4: regimm $s0, $at, +12         ; br -> 0x004242b4
  004242a8: sd     $s1, +200($t3)     
  004242ac: addiu  $t6, $s0, +63      
  004242b0: sra $t6, $t6, 6           
  004242b4: lhu    $s1, +206($t3)     
  004242b8: andi   $t6, $t6, +63      
  004242bc: sll $s0, $t6, 6           
  004242c0: and $t6, $s1, $v1         
  004242c4: or $t6, $t6, $s0          
  004242c8: beq    $zero, $zero, +84     ; br -> 0x00424320
  004242cc: sh     $t6, +206($t3)     
  ...
  004242e8: sra $t6, $s0, 6           
  004242ec: ld     $t9, +208($t3)     
  004242f0: and $t9, $t9, $a1         
  004242f4: or $t9, $t9, $s1          
  004242f8: regimm $s0, $at, +12         ; br -> 0x00424308
  004242fc: sd     $t9, +208($t3)     
  00424300: addiu  $t6, $s0, +63      
  00424304: sra $t6, $t6, 6           
  00424308: lhu    $s0, +214($t3)     
  0042430c: andi   $t6, $t6, +63      
  00424310: sll $t9, $t6, 6           
  00424314: and $t6, $s0, $v1         
  00424318: or $t6, $t6, $t9          
  0042431c: sh     $t6, +214($t3)     
  00424320: addiu  $t5, $t5, +1       
  00424324: slt $t3, $t5, $t7         
  00424328: bne    $t3, $zero, -1224     ; br -> 0x00423e64
  0042432c: sll $s0, $t5, 2           
  ...
  00424350: sll $a2, $v1, 2           
  00424354: addiu  $a1, $zero, -29    
  00424358: andi   $v1, $zero, +1     
  0042435c: sll $a0, $v1, 1           
  00424360: addiu  $v1, $zero, -3     
  00424364: lbu    $a3, +104($t0)        ; GLOBAL 0xfff00068
  00424368: lui   $at, 0x00700000     
  0042436c: and $a1, $a3, $a1         
  00424370: or $a1, $a1, $a2          
  00424374: sb     $a1, +104($t0)        ; GLOBAL 0xfff00068
  00424378: lw     $a2, +19184($at)      ; GLOBAL 0x00704af0
  0042437c: lbu    $a1, +105($a2)     
  00424380: and $v1, $a1, $v1         
  00424384: or $v1, $v1, $a0          
  00424388: beq    $zero, $zero, +76     ; br -> 0x004243d8
  0042438c: sb     $v1, +105($a2)     
  00424390: addiu  $v1, $t8, +1       
  00424394: lw     $t0, +19184($at)      ; GLOBAL 0x00704af0
  00424398: andi   $v1, $v1, +7       
  0042439c: sll $a2, $v1, 2           
  004243a0: addiu  $a1, $zero, -29    
  004243a4: andi   $v1, $zero, +1     
  004243a8: sll $a0, $v1, 1           
  004243ac: addiu  $v1, $zero, -3     
  004243b0: lbu    $a3, +112($t0)        ; GLOBAL 0xfff00070
  004243b4: lui   $at, 0x00700000     
  004243b8: and $a1, $a3, $a1         
  004243bc: or $a1, $a1, $a2          
  004243c0: sb     $a1, +112($t0)        ; GLOBAL 0xfff00070
  004243c4: lw     $a2, +19184($at)      ; GLOBAL 0x00704af0
  004243c8: lbu    $a1, +113($a2)     
  004243cc: and $v1, $a1, $v1         
  004243d0: or $v1, $v1, $a0          
  004243d4: sb     $v1, +113($a2)     
  004243d8: lui   $at, 0x00700000     
  004243dc: lw     $v1, +19184($at)      ; GLOBAL 0x00704af0
  004243e0: sd     $zero, +240($v1)      ; GLOBAL 0xffc000f0
  ...
  0042443c: ld     $a0, +19384($at)      ; GLOBAL 0x00704bb8
  00424440: lui   $at, 0x00650000     
  00424444: or $v1, $a0, $v1          
  00424448: sw     $a1, +16488($at)      ; GLOBAL 0x00654068
  0042444c: lui   $at, 0x00700000     
  00424450: sd     $v1, +19384($at)      ; GLOBAL 0x00704bb8
  00424454: lq     $s1, +16($sp)      
  00424458: lq     $s0, +0($sp)       
  0042445c: jr     $ra                
  ...
  00424484: sll $a3, $a2, 1           
  00424488: lw     $a1, +19864($at)      ; GLOBAL 0x00704d98
  0042448c: sllv $a2, $a0, $a3        
  00424490: sllv $a0, $v1, $a3        
  00424494: nor $v1, $a2, $zero       
  00424498: and $v1, $a1, $v1         
