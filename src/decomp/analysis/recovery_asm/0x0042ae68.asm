...
; 772 words
  ...
  0042ae7c: dsubu $fp, $zero, $zero   
  0042ae80: sw     $s5, +720($sp)     
  0042ae84: dsubu $s7, $zero, $zero   
  0042ae88: sw     $s2, +672($sp)     
  0042ae8c: dsubu $s5, $a2, $zero     
  0042ae90: sw     $ra, +784($sp)     
  0042ae94: dsubu $s2, $a0, $zero     
  ...
  0042af94: dsubu $s4, $zero, $zero   
  0042af98: dsubu $s3, $zero, $zero   
  ...
  0042b280: dsubu $s1, $zero, $zero   
  0042b284: lw     $s0, +4($s2)       
  0042b288: daddu $v0, $s0, $s4       
  0042b28c: beq    $v0, $zero, +52       ; br -> 0x0042b2c4
  0042b290: dsubu $a0, $s2, $zero     
  0042b294: lw     $v0, +0($s2)       
  ...
  0042b8ac: dsubu $a0, $s0, $zero     
  0042b8b0: jal   0xf042acd0             ; -> FUN_0042acd0
  0042b8b4: dsubu $a1, $s2, $zero     
  0042b8b8: addiu  $s1, $s1, -1       
  0042b8bc: lw     $s0, +0($s1)       
  0042b8c0: dsubu $a0, $s0, $zero     
  0042b8c4: jal   0xf042acd0             ; -> FUN_0042acd0
  0042b8c8: dsubu $a1, $s2, $zero     
  ...
  0042b8e0: dsubu $a0, $s6, $zero     
  0042b8e4: dsubu $a0, $v0, $zero     
