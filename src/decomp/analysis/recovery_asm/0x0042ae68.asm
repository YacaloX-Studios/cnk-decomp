...
; 772 words
  ...
  0042ae74: sq     $fp, +768($sp)     
  0042ae78: sq     $s7, +752($sp)     
  0042ae7c: daddu $fp, $zero, $zero   
  0042ae80: sq     $s5, +720($sp)     
  0042ae84: daddu $s7, $zero, $zero   
  0042ae88: sq     $s2, +672($sp)     
  0042ae8c: daddu $s5, $a2, $zero     
  0042ae90: sq     $ra, +784($sp)     
  0042ae94: daddu $s2, $a0, $zero     
  0042ae98: sq     $s6, +736($sp)     
  0042ae9c: sq     $s4, +704($sp)     
  0042aea0: sq     $s3, +688($sp)     
  0042aea4: sq     $s1, +656($sp)     
  0042aea8: sq     $s0, +640($sp)     
  ...
  0042aeec: daddu $s6, $v0, $zero     
  0042aef0: lw     $v1, +608($sp)     
  0042aef4: addu $a0, $a0, $s6        
  ...
  0042af14: addu $v1, $v1, $a0        
  0042af18: lbu    $v0, +0($v1)          ; GLOBAL 0x00650000
  0042af1c: andi   $v0, $v0, +8       
  0042af20: beq    $v0, $zero, +96       ; br -> 0x0042af84
  0042af24: daddu $s0, $a0, $zero     
  ...
  0042af54: daddu $a0, $s2, $zero     
  0042af58: bne    $v0, $zero, +2544     ; br -> 0x0042b94c
  0042af5c: lw     $v0, +620($sp)     
  0042af60: lw     $a0, +0($s2)       
  0042af64: lbu    $v0, +0($a0)       
  0042af68: addu $v0, $v0, $s0        
  0042af6c: lbu    $v1, +0($v0)          ; GLOBAL 0x006a0000
  0042af70: andi   $v1, $v1, +8       
  0042af74: bnel   $v1, $zero, -72       ; br -> 0x0042af30
  0042af78: lw     $v1, +4($s2)       
  0042af7c: beq    $zero, $zero, -180    ; br -> 0x0042aecc
  ...
  0042af94: daddu $s4, $zero, $zero   
  0042af98: daddu $s3, $zero, $zero   
  0042af9c: lw     $v0, +616($sp)     
  0042afa0: lb     $s0, +0($v0)          ; GLOBAL 0x006a0000
  ...
  0042b024: sw     $v0, +4($s2)       
  0042b028: slt $v0, $s0, $s6         
  0042b02c: bne    $v0, $zero, -80       ; br -> 0x0042afe0
  0042b030: addiu  $s1, $s1, +1       
  0042b034: beq    $zero, $zero, -364    ; br -> 0x0042aecc
  0042b038: lui   $v1, 0x00650000     
  0042b03c: beq    $zero, $zero, -164    ; br -> 0x0042af9c
  0042b040: ori    $s3, $s3, +8       
  0042b044: beq    $zero, $zero, -172    ; br -> 0x0042af9c
  0042b048: ori    $s3, $s3, +1       
  0042b04c: beq    $zero, $zero, -180    ; br -> 0x0042af9c
  0042b050: ori    $s3, $s3, +2       
  0042b054: beq    $zero, $zero, -188    ; br -> 0x0042af9c
  0042b058: ori    $s3, $s3, +4       
  0042b05c: addiu  $v0, $zero, +10    
  0042b060: mult   $v0, $s4, +0       
  0042b064: addu $v0, $v1, $s0        
  0042b068: beq    $zero, $zero, -208    ; br -> 0x0042af9c
  ...
  0042b134: bne    $v0, $zero, -620      ; br -> 0x0042aecc
  ...
  0042b14c: lw     $a0, -8($s5)       
  0042b150: beq    $zero, $zero, -648    ; br -> 0x0042aecc
  0042b154: sh     $s7, +0($a0)       
  0042b158: beq    $v0, $zero, +16       ; br -> 0x0042b16c
  0042b15c: addiu  $s5, $s5, +8       
  0042b160: lw     $v0, -8($s5)       
  0042b164: beq    $zero, $zero, -672    ; br -> 0x0042aec8
  0042b168: sd     $s7, +0($v0)          ; GLOBAL 0x00430000
  0042b16c: lw     $a0, -8($s5)       
  0042b170: beq    $zero, $zero, -684    ; br -> 0x0042aec8
  0042b174: sw     $s7, +0($a0)       
  ...
  0042b1e0: lbu    $v1, +0($a0)       
  0042b1e4: addu $v1, $v1, $a1        
  0042b1e8: lbu    $v0, +0($v1)          ; GLOBAL 0x00430000
  0042b1ec: andi   $v0, $v0, +8       
  0042b1f0: beq    $v0, $zero, +88       ; br -> 0x0042b24c
  0042b1f4: sltiu  $v0, $s0, +5       
  0042b1f8: daddu $s1, $a1, $zero     
  0042b1fc: lw     $v0, +4($s2)       
  ...
  0042b220: daddu $a0, $s2, $zero     
  0042b224: bne    $v0, $zero, +1812     ; br -> 0x0042b93c
  0042b228: lw     $v1, +620($sp)     
  0042b22c: lw     $a0, +0($s2)       
  0042b230: lbu    $v0, +0($a0)       
  0042b234: addu $v0, $v0, $s1        
  0042b238: lbu    $v1, +0($v0)          ; GLOBAL 0x006a0000
  0042b23c: andi   $v1, $v1, +8       
  0042b240: bnel   $v1, $zero, -68       ; br -> 0x0042b200
  0042b244: lw     $v0, +4($s2)       
  0042b248: sltiu  $v0, $s0, +5       
  0042b24c: beq    $v0, $zero, -900      ; br -> 0x0042aecc
  0042b250: lui   $v1, 0x00650000     
  0042b254: lui   $v0, 0x006a0000     
  0042b258: sll $v1, $s0, 2           
  0042b25c: addiu  $v0, $v0, +18352   
  0042b260: addu $v1, $v1, $v0        
  ...
  0042b27c: movz   $s4, $v0, $s4      
  0042b280: daddu $s1, $zero, $zero   
  0042b284: lw     $s0, +4($s2)       
  0042b288: sltu $v0, $s0, $s4        
  0042b28c: beq    $v0, $zero, +52       ; br -> 0x0042b2c4
  0042b290: daddu $a0, $s2, $zero     
  0042b294: lw     $v0, +0($s2)       
  0042b298: addu $s1, $s1, $s0        
  0042b29c: subu $s4, $s4, $s0        
  0042b2a0: addu $v0, $v0, $s0        
  0042b2a4: jal   0xf042a818             ; -> FUN_0042a818
  0042b2a8: sw     $v0, +0($s2)       
  0042b2ac: beql   $v0, $zero, -40       ; br -> 0x0042b288
  0042b2b0: lw     $s0, +4($s2)       
  0042b2b4: beq    $s1, $zero, +1664     ; br -> 0x0042b938
  0042b2b8: addu $s7, $s7, $s1        
  0042b2bc: beq    $zero, $zero, -1012   ; br -> 0x0042aecc
  0042b2c0: lui   $v1, 0x00650000     
  0042b2c4: lw     $v1, +0($s2)       
  0042b2c8: subu $v0, $s0, $s4        
  0042b2cc: sw     $v0, +4($s2)       
  0042b2d0: addu $s1, $s1, $s4        
  0042b2d4: addu $v1, $v1, $s4        
  0042b2d8: sw     $v1, +0($s2)       
  0042b2dc: beq    $zero, $zero, -1048   ; br -> 0x0042aec8
  0042b2e0: addu $s7, $s7, $s1        
  0042b2e4: addiu  $s5, $s5, +8       
  0042b2e8: daddu $a2, $s4, $zero     
  0042b2ec: lw     $a0, -8($s5)       
  0042b2f0: addiu  $a1, $zero, +1     
  0042b2f4: jal   0xf0429fb8             ; -> 0x00429fb8
  0042b2f8: daddu $a3, $s2, $zero     
  0042b2fc: beq    $v0, $zero, +1592     ; br -> 0x0042b938
  0042b300: lw     $a0, +620($sp)     
  0042b304: addu $s7, $s7, $v0        
  0042b308: addiu  $a0, $a0, +1       
  0042b30c: beq    $zero, $zero, -1096   ; br -> 0x0042aec8
  ...
  0042b324: movz   $s4, $v0, $s4      
  0042b328: daddu $s0, $zero, $zero   
  0042b32c: lw     $a1, +0($s2)       
  0042b330: lbu    $v0, +0($a1)       
  0042b334: addu $v1, $sp, $v0        
  0042b338: lb     $a0, +0($v1)          ; GLOBAL 0x00650000
  ...
  0042b430: movz   $s4, $v0, $s4      
  0042b434: lui   $v0, 0x006a0000     
  0042b438: daddu $s0, $zero, $zero   
  0042b43c: addiu  $s1, $v0, +17361   
  0042b440: lw     $a0, +0($s2)       
  0042b444: sll $zero, $zero, 0       
  0042b448: lbu    $v0, +0($a0)       
  0042b44c: addu $v0, $v0, $s1        
  0042b450: lbu    $v1, +0($v0)          ; GLOBAL 0x006a0000
  ...
  0042b478: sw     $v1, +4($s2)       
  0042b47c: bgtzl  $v1, $zero, -56       ; br -> 0x0042b448
  0042b480: lw     $a0, +0($s2)       
  0042b484: jal   0xf042a818             ; -> FUN_0042a818
  0042b488: daddu $a0, $s2, $zero     
  0042b48c: beql   $v0, $zero, -72       ; br -> 0x0042b448
  0042b490: lw     $a0, +0($s2)       
  0042b494: beq    $zero, $zero, -1488   ; br -> 0x0042aec8
  0042b498: addu $s7, $s7, $s0        
  ...
  0042b4b4: daddu $s0, $s1, $zero     
  0042b4b8: lw     $a1, +0($s2)       
  0042b4bc: sll $zero, $zero, 0       
  0042b4c0: lbu    $v0, +0($a1)       
  0042b4c4: addu $v0, $v0, $s6        
  0042b4c8: lbu    $v1, +0($v0)          ; GLOBAL 0x006a0000
  ...
  0042b5ac: sll $v1, $fp, 1           
  0042b5b0: addiu  $v0, $v0, +17808   
  0042b5b4: addiu  $a0, $zero, -449   
  0042b5b8: addu $v1, $v1, $v0        
  0042b5bc: and $s3, $s3, $a0         
  0042b5c0: beq    $zero, $zero, +112    ; br -> 0x0042b634
  0042b5c4: lh     $fp, +0($v1)          ; GLOBAL 0x00650000
  0042b5c8: lui   $v0, 0x006a0000     
  0042b5cc: sll $v1, $fp, 1           
  0042b5d0: addiu  $v0, $v0, +17808   
  0042b5d4: addu $v1, $v1, $v0        
  0042b5d8: lh     $fp, +0($v1)          ; GLOBAL 0x00650000
  ...
  0042b6b8: daddu $a0, $s0, $zero     
  0042b6bc: addiu  $s1, $s1, -1       
  0042b6c0: jal   0xf042acd0             ; -> FUN_0042acd0
  0042b6c4: daddu $a1, $s2, $zero     
  0042b6c8: andi   $v0, $s3, +8       
  0042b6cc: bne    $v0, $zero, +608      ; br -> 0x0042b930
  0042b6d0: subu $v0, $s1, $s6        
  0042b6d4: sb     $zero, +0($s1)     
  0042b6d8: daddu $a0, $s6, $zero     
  0042b6dc: daddu $a1, $zero, $zero   
  0042b6e0: lw     $v1, +624($sp)     
  0042b6e4: jalr   $v1, $ra           
  0042b6e8: daddu $a2, $fp, $zero     
  0042b6ec: daddu $v1, $v0, $zero     
  ...
  0042b740: sd     $v1, +0($v0)          ; GLOBAL 0x006a0000
  ...
  0042b8ac: daddu $a0, $s0, $zero     
  0042b8b0: jal   0xf042acd0             ; -> FUN_0042acd0
  0042b8b4: daddu $a1, $s2, $zero     
  0042b8b8: addiu  $s1, $s1, -1       
  0042b8bc: lb     $s0, +0($s1)       
  0042b8c0: daddu $a0, $s0, $zero     
  0042b8c4: jal   0xf042acd0             ; -> FUN_0042acd0
  0042b8c8: daddu $a1, $s2, $zero     
  0042b8cc: andi   $v0, $s3, +8       
  0042b8d0: bne    $v0, $zero, +92       ; br -> 0x0042b930
  0042b8d4: subu $v0, $s1, $s6        
  0042b8d8: sb     $zero, +0($s1)     
  0042b8dc: jal   0xf042bd98             ; -> FUN_0042bd98
  0042b8e0: daddu $a0, $s6, $zero     
  0042b8e4: daddu $a0, $v0, $zero     
  ...
  0042b90c: sd     $a0, +0($v0)          ; GLOBAL 0x006a0000
  ...
  0042b92c: subu $v0, $s1, $s6        
  0042b930: beq    $zero, $zero, -2668   ; br -> 0x0042aec8
  0042b934: addu $s7, $s7, $v0        
  0042b938: lw     $v1, +620($sp)     
  0042b93c: addiu  $v0, $zero, -1     
  0042b940: beq    $zero, $zero, +8      ; br -> 0x0042b94c
  0042b944: movn   $v0, $v1, $v1      
  0042b948: lw     $v0, +620($sp)     
  0042b94c: lq     $ra, +784($sp)     
  0042b950: lq     $fp, +768($sp)     
  0042b954: lq     $s7, +752($sp)     
  0042b958: lq     $s6, +736($sp)     
  0042b95c: lq     $s5, +720($sp)     
  0042b960: lq     $s4, +704($sp)     
  0042b964: lq     $s3, +688($sp)     
  0042b968: lq     $s2, +672($sp)     
  0042b96c: lq     $s1, +656($sp)     
  0042b970: lq     $s0, +640($sp)     
  0042b974: jr     $ra                
  ...
  0042ba04: beq    $a3, $zero, -52       ; br -> 0x0042b9d4
  0042ba08: daddu $a2, $a3, $zero     
  0042ba0c: beq    $zero, $zero, -44     ; br -> 0x0042b9e4
  0042ba10: addu $v0, $a0, $a2        
  0042ba14: beq    $a3, $v0, +84         ; br -> 0x0042ba6c
  0042ba18: daddu $a2, $a3, $zero     
  0042ba1c: beq    $zero, $zero, -60     ; br -> 0x0042b9e4
  0042ba20: addu $v0, $a0, $a2        
  0042ba24: lb     $a3, +0($a1)       
  0042ba28: addiu  $v0, $zero, +93    
  0042ba2c: beq    $a3, $v0, +12         ; br -> 0x0042ba3c
  0042ba30: slt $v0, $a3, $a2         
  0042ba34: beql   $v0, $zero, +16       ; br -> 0x0042ba48
  0042ba38: addiu  $a1, $a1, +1       
  0042ba3c: beq    $zero, $zero, -96     ; br -> 0x0042b9e0
  0042ba40: addiu  $a2, $zero, +45    
  0042ba44: sll $zero, $zero, 0       
  0042ba48: addiu  $a2, $a2, +1       
  0042ba4c: addu $v0, $a0, $a2        
  0042ba50: slt $v1, $a2, $a3         
  0042ba54: sll $zero, $zero, 0       
  0042ba58: sll $zero, $zero, 0       
  0042ba5c: bne    $v1, $zero, -24       ; br -> 0x0042ba48
  0042ba60: sb     $t0, +0($v0)          ; GLOBAL 0x006a0000
  0042ba64: beq    $zero, $zero, -124    ; br -> 0x0042b9ec
  0042ba68: lb     $a3, +0($a1)       
  0042ba6c: jr     $ra                
  0042ba70: daddu $v0, $a1, $zero     
