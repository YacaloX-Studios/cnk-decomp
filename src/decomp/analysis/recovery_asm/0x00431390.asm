...
; 62 words
  ...
  00431394: sw     $s0, +48($sp)      
  00431398: dsubu $s0, $a0, $zero     
  0043139c: sw     $ra, +112($sp)     
  004313a0: sw     $s3, +96($sp)      
  004313a4: sw     $s2, +80($sp)      
  004313a8: jal   0xf042c5c0             ; -> FUN_0042c5c0
  004313ac: sw     $s1, +64($sp)      
  004313b0: jal   0xf04311f0             ; -> FUN_004311f0
  004313b4: sll $zero, $zero, 0       
  004313b8: lui   $v0, 0x00650000     
  004313bc: lui   $v1, 0x00650000     
  004313c0: lw     $s2, +32504($v0)      ; GLOBAL 0x00657ef8
  ...
  0043143c: dsubu $a0, $s1, $zero     
  00431440: lui   $a1, 0x006a0000     
  00431444: dsubu $a2, $s3, $zero     
  00431448: addiu  $a1, $a1, +19664   
  0043144c: jal   0xf0429cf0             ; -> 0x00429cf0
  00431450: dsubu $a0, $s1, $zero     
  00431454: lui   $a1, 0x006a0000     
  00431458: lw     $a2, +28($sp)      
  0043145c: dsubu $a0, $s1, $zero     
  00431460: jal   0xf0429cf0             ; -> 0x00429cf0
  00431464: addiu  $a1, $a1, +19696   
  00431468: lw     $ra, +112($sp)     
  0043146c: lw     $s3, +96($sp)      
  00431470: lw     $s2, +80($sp)      
  00431474: lw     $s1, +64($sp)      
  00431478: lw     $s0, +48($sp)      
  0043147c: jr     $ra                
