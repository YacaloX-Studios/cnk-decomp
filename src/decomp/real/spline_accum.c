/* ============================================================================
 * FUN_003ae0e0  spline_accum
 * module: math/spline
 * Accumulates quadratic cross terms from three points/weights into BSS (spline/curve arc length-style).
 * raw address: 0x003ae0e0  (ELF vaddr 0x00100000 + file offset)
 * ======================================================================== */
