/* ============================================================================
 * FUN_00534b60  heap_alloc_block
 * module: core/mem
 * Fixed-pool sub-allocator: rounds requested sizes to alignment, carves blocks out of a heap header (min size at +8, used at +0x1c, freelist at +0x20). Fail sentinel DAT_006b6498.
