/* ============================================================================
 * FUN_0042a818  script_step
 * module: game/script
 * Script/task state machine step: manages a flag word (ushort +0xc), calls step callbacks from a pointer table, tracks completion bits.
 * raw address: 0x0042a818  (ELF vaddr 0x00100000 + file offset)
 * ======================================================================== */
